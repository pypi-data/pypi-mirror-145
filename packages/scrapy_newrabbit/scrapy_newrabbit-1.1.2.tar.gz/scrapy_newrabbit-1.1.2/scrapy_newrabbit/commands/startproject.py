...
from scrapy_newrabbit.utils.template import render_templatefile, string_camelcase
from scrapy.exceptions import UsageError

TEMPLATES_TO_RENDER = (
    ('rabbitmq_delect.py.tmpl',),
    ('scrapy.cfg',),
...
class Command(ScrapyCommand):
    ...
    def run(self, args, opts):
        ...
        print("    scrapy_newrabbit genspider examplepackage examplespider example.com")
