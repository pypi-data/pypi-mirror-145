...
class DatasetSummaryModel(object):
    ...
    def __init__(self, id=None, name=None, description=None, default_profile_id=None, created_date=None, storage=None, secure_monitoring_enabled=False, cloud_platform=None, data_project=None, storage_account=None, phs_id=None, local_vars_configuration=None):  # noqa: E501
