...
from pyabsa.utils.scheduler import GradualWarmupScheduler
...
class Instructor:
    def __init__(self, opt, logger):
        ...
        self.scheduler_steplr = StepLR(self.optimizer, step_size=self.opt.log_step, gamma=0.1)
        self.scheduler_warmup = GradualWarmupScheduler(self.optimizer,
                                                       multiplier=1,
                                                       total_epoch=self.opt.num_epoch//10,
