...
class LoggerFilterinstabotClubOnly(logging.Filter):
    def filter(self, record: LogRecord):
        return record.name.startswith("instabotClub")
...
def create_log_file_handler(filename):
    ...
    file_handler.addFilter(LoggerFilterinstabotClubOnly())
    return file_handler
...
def configure_logger(debug, username):
    ...
    console_handler.addFilter(LoggerFilterinstabotClubOnly())
