...
from instabotClub.core.device_facade import create_device, get_device_info
from instabotClub.core.filter import Filter
from instabotClub.core.filter import load_config as load_filter
from instabotClub.core.interaction import load_config as load_interaction
from instabotClub.core.log import (
    configure_logger,
    is_log_file_updated,
    update_log_file_name,
)
from instabotClub.core.navigation import check_if_english
from instabotClub.core.persistent_list import PersistentList
from instabotClub.core.report import print_full_report
from instabotClub.core.session_state import SessionState, SessionStateEncoder
from instabotClub.core.storage import Storage
from instabotClub.core.utils import (
    ask_for_a_donation,
    can_repeat,
...
from instabotClub.core.utils import load_config as load_utils
from instabotClub.core.utils import (
...
from instabotClub.core.views import AccountView, ProfileView, TabBarView, UniversalActions
from instabotClub.core.views import load_config as load_views
...
def start_bot(**kwargs):
    ...
    if not kwargs:
        if "--config" not in configs.args:
            logger.info(
                "It's strongly recommend to use a config.yml file. Follow these links for more details:https://docs.instabot.club/configuration/general-configuration",
