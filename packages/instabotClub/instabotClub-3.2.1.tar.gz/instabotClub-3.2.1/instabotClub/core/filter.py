...
from instabotClub.core.device_facade import Timeout
from instabotClub.core.resources import ResourceID as resources
from instabotClub.core.utils import random_sleep
from instabotClub.core.views import FollowStatus, ProfileView
...
class Filter:
    ...
    def __init__(self, storage=None):
        ...
        if self.conditions is not None:
            ...
            logger.warning(
                "The filters file doesn't exists in your account folder. Please, Contact me!\n\tEmail: instabotclub@gamil.com"
            )
