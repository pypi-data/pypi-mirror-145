from .dev import connection_udp
...
class RT2:
    ...
    def __init__(self):
        ...
        self.__other_channel = connection_udp.TalkPort(65431)
        self.__motors_channel = connection_udp.TalkPort(65432)
        self.__oms_channel = connection_udp.TalkPort(65433)
        self.__resets_channel = connection_udp.TalkPort(65434)
        self.__encs_channel = connection_udp.ListenPort(65435)
        self.__sensors_channel = connection_udp.ListenPort(65436)
        self.__buttons_channel = connection_udp.ListenPort(65437)
        self.__camera_channel = connection_udp.ListenPort(65438, True)
