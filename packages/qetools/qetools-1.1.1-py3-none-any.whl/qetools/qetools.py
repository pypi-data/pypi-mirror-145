def main():	
    ...
    if 'aprun' in list_executables(): parallel='aprun'

    ncores = 1 

    if os.cpu_count() > 3:
        ncores = (os.cpu_count()//2 - 1)*2
    ...
    parse.add_argument('-ns', '--nofstructures', help='Number of structures for EoS fitting', default=10, type=int)
