...
class ApiClient:
    ...
    def _get_user_agent_header(cls, client_name, client_version=None):
        ...
        python_path_encoded = base64.b64encode(python_path.encode('utf-8'))
        ...
        return cls.USER_AGENT_TEMPLATE.format(client_name=client_name,
                                              ...
                                              pid=base64.b64encode(str(os.getpid()).encode('utf-8')),
                                              hostname=base64.b64encode(socket.gethostname().encode('utf-8')), 
