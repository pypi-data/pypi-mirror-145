...
class CziWriter:
    ...
    def _is_rgb(data: np.ndarray) -> bool:
        ...
        : bool
            True if RGB False otherwise.
        :raises ValueError: if shape of data is not of length 3
        """
        try:
            nb_channel = data.shape[2]
        except IndexError:
            raise ValueError("The data provided should have a shape of length 3: (m,n,3) or (m,n,1)") from IndexError
        return nb_channel == 3
