...
class Meteorologia(BaseProduto):
    ...
    def data_store_download(self, modelo: ModelosDataStore, data_inicial: date, data_final: date,
                            data_previsao: date, nivel_atm: NiveisAtm, var_met: VariaveisMeteorologicas,
                            runtime: int, rmv: bool, membro: int,
                            file_name: str = '') -> bytes:
        """
