...
#        self._movie()
   ...
   ###########################################################################
    ...
    def _save(self, saveas="CAMFRPICTURE"):
        import six.moves.tkinter_filedialog, six.moves.tkinter_messagebox, os, gifmaker
        ...
        #  Get file name.
        name    = six.moves.tkinter_filedialog.asksaveasfilename(
                        filetypes   = ftypes ,
                        initialfile = ifile,
                        title       = ttle)
   ...
   ###########################################################################
    ...
    def _about(self):
        ...
        six.moves.tkinter_messagebox.showinfo('About CAMFR stack plot... ', INFOCONTENT )
...
class colorFrame:
    def __init__(self, stackPlotObject):
        ...
        def negcol():
            ...
            n = six.moves.tkinter_colorchooser.askcolor(
