    ...
    PyTrampolineCfgBase_frc__sim__SingleJointedArmSim< CfgBase>
{
    ...
    using override_base_UpdateX_KRTVector_double_2__KRTVector_double_1__Tsecond_t = frc::sim::SingleJointedArmSim;
};
...
#ifndef RPYGEN_DISABLE_UpdateX_KRTVector_double_2__KRTVector_double_1__Tsecond_t
    Eigen::Vector<double, 2 > UpdateX(const Eigen::Vector<double, 2>& currentXhat, const Eigen::Vector<double, 1>& u, units::second_t dt) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_UpdateX_KRTVector_double_2__KRTVector_double_1__Tsecond_t;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(Eigen::Vector<double, 2 >), LookupBase,
