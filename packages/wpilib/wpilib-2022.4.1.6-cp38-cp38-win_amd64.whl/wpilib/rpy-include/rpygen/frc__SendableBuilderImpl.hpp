    ...
    PyTrampolineCfgBase_frc__SendableBuilderImpl< CfgBase>
{
    ...
    using override_base_SetUpdateTable_Tfunction_void___ = frc::SendableBuilderImpl;
    using override_base_GetEntry_Tstring_view = frc::SendableBuilderImpl;
    ...
    using override_base_AddRawProperty_Tstring_view_Tstring____Tstring_view__ = frc::SendableBuilderImpl;
    using override_base_AddValueProperty_Tstring_view_TValue_____TValue___ = frc::SendableBuilderImpl;
    ...
    using override_base_AddSmallRawProperty_Tstring_view_TSmallVectorImpl_char__buf___Tstring_view__ = frc::SendableBuilderImpl;
};
...
struct PyTrampoline_frc__SendableBuilderImpl : PyTrampolineBase_frc__SendableBuilderImpl<PyTrampolineBase, PyTrampolineCfg> {
    ...
    void SetSmartDashboardType(std::string_view type) override {
        ...
        return CxxCallBase::SetSmartDashboardType(type);
    }
#endif
    ...
    void SetActuator(bool value) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(void), LookupBase,
            "setActuator", value);
        return CxxCallBase::SetActuator(value);
    }
#endif
    ...
    void SetSafeState(std::function<void ( )> func) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(void), LookupBase,
            "setSafeState", func);
        return CxxCallBase::SetSafeState(func);
    }
#endif
    ...
    void SetUpdateTable(std::function<void ( )> func) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_SetUpdateTable_Tfunction_void___;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(void), LookupBase,
            "setUpdateTable", func);
        return CxxCallBase::SetUpdateTable(func);
    }
#endif
    ...
    nt::NetworkTableEntry GetEntry(std::string_view key) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_GetEntry_Tstring_view;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(nt::NetworkTableEntry), LookupBase,
            "getEntry", key);
        return CxxCallBase::GetEntry(key);
    }
#endif
    ...
    void AddBooleanProperty(std::string_view key, std::function<bool ( )> getter, std::function<void ( bool )> setter) override {
        ...
        return CxxCallBase::AddBooleanProperty(key, getter, setter);
    }
#endif
    ...
    void AddDoubleProperty(std::string_view key, std::function<double ( )> getter, std::function<void ( double )> setter) override {
        ...
        return CxxCallBase::AddDoubleProperty(key, getter, setter);
    }
#endif
    ...
    void AddStringProperty(std::string_view key, std::function<std::string ( )> getter, std::function<void ( std::string_view )> setter) override {
        ...
        return CxxCallBase::AddStringProperty(key, getter, setter);
    }
#endif
    ...
    void AddBooleanArrayProperty(std::string_view key, std::function<std::vector<int> ( )> getter, std::function<void ( wpi::span<const int> )> setter) override {
        ...
        return CxxCallBase::AddBooleanArrayProperty(key, getter, setter);
    }
#endif
    ...
    void AddDoubleArrayProperty(std::string_view key, std::function<std::vector<double> ( )> getter, std::function<void ( wpi::span<const double> )> setter) override {
        ...
        return CxxCallBase::AddDoubleArrayProperty(key, getter, setter);
    }
#endif
    ...
    void AddStringArrayProperty(std::string_view key, std::function<std::vector<std::string> ( )> getter, std::function<void ( wpi::span<const std::string> )> setter) override {
        ...
        return CxxCallBase::AddStringArrayProperty(key, getter, setter);
    }
#endif
    ...
    void AddRawProperty(std::string_view key, std::function<std::string ( )> getter, std::function<void ( std::string_view )> setter) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_AddRawProperty_Tstring_view_Tstring____Tstring_view__;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(void), LookupBase,
            "addRawProperty", key, getter, setter);
        return CxxCallBase::AddRawProperty(key, getter, setter);
    }
#endif

#ifndef RPYGEN_DISABLE_AddValueProperty_Tstring_view_TValue_____TValue___
    void AddValueProperty(std::string_view key, std::function<std::shared_ptr<nt::Value> ( )> getter, std::function<void ( std::shared_ptr<nt::Value> )> setter) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_AddValueProperty_Tstring_view_TValue_____TValue___;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(void), LookupBase,
            "addValueProperty", key, getter, setter);
        return CxxCallBase::AddValueProperty(key, getter, setter);
    }
#endif
    ...
    void AddSmallStringProperty(std::string_view key, std::function<std::string_view ( wpi::SmallVectorImpl<char> & buf )> getter, std::function<void ( std::string_view )> setter) override {
        ...
        return CxxCallBase::AddSmallStringProperty(key, getter, setter);
    }
#endif
    ...
    void AddSmallBooleanArrayProperty(std::string_view key, std::function<wpi::span<const int> ( wpi::SmallVectorImpl<int> & buf )> getter, std::function<void ( wpi::span<const int> )> setter) override {
        ...
        return CxxCallBase::AddSmallBooleanArrayProperty(key, getter, setter);
    }
#endif
    ...
    void AddSmallDoubleArrayProperty(std::string_view key, std::function<wpi::span<const double> ( wpi::SmallVectorImpl<double> & buf )> getter, std::function<void ( wpi::span<const double> )> setter) override {
        ...
        return CxxCallBase::AddSmallDoubleArrayProperty(key, getter, setter);
    }
#endif
    ...
    void AddSmallStringArrayProperty(std::string_view key, std::function<wpi::span<const std::string> ( wpi::SmallVectorImpl<std::string> & buf )> getter, std::function<void ( wpi::span<const std::string> )> setter) override {
        ...
        return CxxCallBase::AddSmallStringArrayProperty(key, getter, setter);
    }
#endif
    ...
    void AddSmallRawProperty(std::string_view key, std::function<std::string_view ( wpi::SmallVectorImpl<char> & buf )> getter, std::function<void ( std::string_view )> setter) override {
        using LookupBase = typename PyTrampolineCfg::Base;
        using CxxCallBase = typename PyTrampolineCfg::override_base_AddSmallRawProperty_Tstring_view_TSmallVectorImpl_char__buf___Tstring_view__;
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(void), LookupBase,
            "addSmallRawProperty", key, getter, setter);
        return CxxCallBase::AddSmallRawProperty(key, getter, setter);
    }
#endif
