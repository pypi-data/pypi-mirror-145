...
setup(
    name='imgtobase64',
    version='1.1.1',
    description='Convert your image url from web or your image field from database to base64',
    ...
    url='https://github.com/VolkenoMakers/imgtobase64',  # the URL of your package's home page e.g. github link
    author='VOLKENO',
