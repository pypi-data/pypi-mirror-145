...
if __name__ == '__main__':
    ...
    os.environ[
        'MELAX_TECH_KEY'] = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJubHB1cmwiOiJodHRwczovL3Rlc3QuZGRpZHIwc2todXF4cy5hbXBsaWZ5YXBwLmNvbSIsInVzZXJJZCI6IjEiLCJ1cmwiOiJodHRwczovL21lcmljLWRldi5tZWxheHRlY2guY29tIn0.Qw6S5TxUrFKCk-Pvhl8PT5BHUwEErxP6Eqo1-pLGe14"
    ...
    response = client.visualization(input1, "tf-problem-pipeline-lambda:v1.0.0")
    print(response)
    # response = client.visualization(input, "Comprehensive Clinical Information:v1.0.0")
