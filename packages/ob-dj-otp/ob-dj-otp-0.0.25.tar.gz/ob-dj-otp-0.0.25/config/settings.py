...
OTP_USER_SERIALIZER = os.getenv("OTP_USER_SERIALIZER", None)
...
# This variable sould contain the serializer name and path to mixin
# Exapmle : {"OTPRequestCodeSerializer": "path.to.mixin_class"}
