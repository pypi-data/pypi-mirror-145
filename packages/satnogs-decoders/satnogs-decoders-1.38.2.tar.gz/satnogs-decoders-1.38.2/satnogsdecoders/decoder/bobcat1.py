...
class Bobcat1(KaitaiStruct):
    ...
    :field pos_sol_status: frame.xyz.pos_sol_status
    :field gps_week: frame.xyz.gps_week
    :field gps_ms: frame.xyz.gps_ms
    :field pos_x: frame.xyz.pos_x
    :field pos_y: frame.xyz.pos_y
    :field pos_z: frame.xyz.pos_z
    :field vel_x: frame.xyz.vel_x
    :field vel_y: frame.xyz.vel_y
    :field vel_z: frame.xyz.vel_z
    :field vel_latency: frame.xyz.vel_latency
    :field diff_age: frame.xyz.diff_age
    :field sol_age: frame.xyz.sol_age
    :field num_soln_svs: frame.xyz.num_soln_svs
    """
