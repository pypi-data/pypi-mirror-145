...
class MlPlatformApi:
    def __init__(self, api_client: ApiClient = None, local_mount_path="./tmp"):
        ...
        if self.api_client.run_mode == RunMode.LOCAL:
            ...
            self.train_data_object_list = self.local_checker.train_data_object_list
        ...
        if self.api_client.run_mode == RunMode.KUBERNETES:
            ...
            self.train_data_object_list = os.environ["dataObjectList"] if "dataObjectList" in os.environ else []
