...
class MlPlatformLocalChecker:
    def __init__(self, api_client: ApiClient):
        ...
        self.train_data_object_info_list: List[ExperimentDataObjectInfo] = api_client.train_data_object_list
    ...
    def _check_train_data_object_list_exist(self):
        ...
        for do_info in do_list:
            for data_object_info in self.train_data_object_info_list:
                if do_info.name == data_object_info.doName:
                    data_object_info.doId = do_info.id

        not_exist_do_name_list = [data_object_info.doName for data_object_info in self.train_data_object_info_list
                                  if data_object_info.doId is None]
