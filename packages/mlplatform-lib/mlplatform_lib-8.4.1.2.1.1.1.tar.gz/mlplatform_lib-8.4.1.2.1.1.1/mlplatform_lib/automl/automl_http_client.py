...
from mlplatform_lib.dataclass.train import TrainAutomlDto
...
class AutomlHttpClient(MlPlatformHttpClient):
    ...
    def get_train(self, experiment_id:int, train_id: int) ->[TrainAutomlDto]:
        ...
        return from_dict(TrainAutomlDto, result.data)
    ...
    def update_train(
        self, experiment_id: int, train_automl_dto: TrainAutomlDto
    ) -> TrainAutomlDto:
        result = self.send_request(
            "trains",
            {"experiments": experiment_id},
            {},
            to_dict(train_automl_dto),
