...
if sys.platform == "win32":
    ...
    create_dir_symlink('..\\..\\csrc', '.\\deepspeed_moee\\ops\\csrc')
    create_dir_symlink('..\\..\\op_builder', '.\\deepspeed_moee\\ops\\op_builder')
