...
from src.InstagramFakeAPI.lib.util.generator import Generations
from src.InstagramFakeAPI.lib.constant.header import *
from src.InstagramFakeAPI.v187.entity.credential import CredentialCustom
...
class Header(CredentialCustom, Generations):
    ...
    def __init__(self, logger: logging, salt: str):
        self.__log = logger
        self.__log.debug('Start Header')
        CredentialCustom.__init__(self, logger, '1', '2', '3')
        Generations.__init__(self, logger, salt)
