...
async def test_authorize_success(mock_request: Mock):
    mock_request.config_dict = {"auth_token": "mock_auth_token"}
    make_auth_proxy_app("mock_auth_token")
...
async def test_authorize_failure(mock_request: Mock):
    mock_request.config_dict = {"auth_token": "mock_auth_token"}
    make_auth_proxy_app("mock_auth_token")
