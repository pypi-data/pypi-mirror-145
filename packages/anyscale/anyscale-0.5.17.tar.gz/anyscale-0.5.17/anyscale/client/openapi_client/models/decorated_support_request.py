...
class DecoratedSupportRequest(object):
    ...
    def __init__(self, id=None, requester_id=None, organization_id=None, requested_at=None, expires_at=None, requester=None, local_vars_configuration=None):  # noqa: E501
