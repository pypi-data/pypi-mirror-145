...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, retain_repo_versions=None, pulp_href=None, description=None, pulp_labels=None, pulp_created=None, manifest_signing_service=None, versions_href=None, name=None, local_vars_configuration=None):  # noqa: E501
