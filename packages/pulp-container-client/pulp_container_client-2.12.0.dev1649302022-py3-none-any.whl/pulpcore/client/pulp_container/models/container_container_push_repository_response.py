...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, pulp_created=None, name=None, manifest_signing_service=None, retain_repo_versions=None, latest_version_href=None, pulp_labels=None, versions_href=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
