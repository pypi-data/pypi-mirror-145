...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, manifest_signing_service=None, name=None, latest_version_href=None, pulp_labels=None, retain_repo_versions=None, description=None, pulp_created=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
