...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, pulp_labels=None, latest_version_href=None, pulp_created=None, versions_href=None, name=None, description=None, retain_repo_versions=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
