...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, manifest_signing_service=None, pulp_labels=None, name=None, description=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
