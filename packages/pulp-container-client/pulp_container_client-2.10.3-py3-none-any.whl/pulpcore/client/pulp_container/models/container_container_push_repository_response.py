...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, latest_version_href=None, name=None, pulp_created=None, pulp_href=None, versions_href=None, retain_repo_versions=None, description=None, local_vars_configuration=None):  # noqa: E501
