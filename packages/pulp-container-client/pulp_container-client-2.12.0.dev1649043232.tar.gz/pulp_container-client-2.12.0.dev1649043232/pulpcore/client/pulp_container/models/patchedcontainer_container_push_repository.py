...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, manifest_signing_service=None, retain_repo_versions=None, pulp_labels=None, description=None, local_vars_configuration=None):  # noqa: E501
