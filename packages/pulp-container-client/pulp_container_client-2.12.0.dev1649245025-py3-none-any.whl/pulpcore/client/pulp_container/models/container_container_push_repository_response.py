...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, versions_href=None, name=None, pulp_href=None, retain_repo_versions=None, pulp_labels=None, manifest_signing_service=None, description=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
