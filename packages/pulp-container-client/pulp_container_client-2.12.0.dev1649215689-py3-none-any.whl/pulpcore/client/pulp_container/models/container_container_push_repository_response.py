...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, pulp_href=None, versions_href=None, description=None, retain_repo_versions=None, pulp_created=None, manifest_signing_service=None, name=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
