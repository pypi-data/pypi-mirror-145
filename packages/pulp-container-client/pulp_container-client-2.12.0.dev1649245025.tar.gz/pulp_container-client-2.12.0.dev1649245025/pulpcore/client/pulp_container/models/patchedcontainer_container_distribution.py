...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, name=None, content_guard=None, base_path=None, pulp_labels=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
