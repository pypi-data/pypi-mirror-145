    ...
    class GenerateInventory:
        ...
        def Inventory(self):
            try:
                ...
                AlphaSurface = self.mod_Pygame__.Surface((self.realWidth, self.realHeight), self.mod_Pygame__.HWSURFACE|self.mod_Pygame__.SRCALPHA)
                ...
                if self.aa == True:
                    if self.platform == "Linux":
                        pilImage = self.mod_PIL_Image_.open(self.mod_OS__.path.join(self.base_folder, ("Resources//General_Resources//PauseIMG.png"))).resize((self.realWidth, self.realHeight), self.mod_PIL_Image_.ANTIALIAS)
                    else:
                        pilImage = self.mod_PIL_Image_.open(self.mod_OS__.path.join(self.base_folder, ("Resources\\General_Resources\\PauseIMG.png"))).resize((self.realWidth, self.realHeight), self.mod_PIL_Image_.ANTIALIAS)
                else:
                    if self.platform == "Linux":
                        pilImage = self.mod_PIL_Image_.open(self.mod_OS__.path.join(self.base_folder, ("Resources//General_Resources//PauseIMG.png"))).resize((self.realWidth, self.realHeight))
                    else:
                        pilImage = self.mod_PIL_Image_.open(self.mod_OS__.path.join(self.base_folder, ("Resources\\General_Resources\\PauseIMG.png"))).resize((self.realWidth, self.realHeight))
                ...
                while True:
                    ...
                    self.Display.blit(WeaponsText, ((self.realWidth-WeaponsTextWidth)-2, 200*yScaleFact))

                    if hover1 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(WeaponsTextWidth+SelectorWidth)-2, 200*yScaleFact))
                        
                    self.Display.blit(RangedWeaponsText, ((self.realWidth-RangedWeaponsTextWidth)-2, 250*yScaleFact))
                    if hover2 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(RangedWeaponsTextWidth+SelectorWidth)-2, 250*yScaleFact))
                        
                    self.Display.blit(ShieldsText, ((self.realWidth-ShieldsTextWidth)-2, 300*yScaleFact))
                    if hover3 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(ShieldsTextWidth+SelectorWidth)-2, 300*yScaleFact))
                        
                    self.Display.blit(ArmourText, ((self.realWidth-ArmourTextWidth)-2, 350*yScaleFact))
                    if hover4 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(FoodTextWidth+SelectorWidth)-2, 400*yScaleFact))
                        
                    self.Display.blit(FoodText, ((self.realWidth-FoodTextWidth)-2, 400*yScaleFact))
                    if hover5 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(ArmourTextWidth+SelectorWidth)-2, 350*yScaleFact))
                        
                    self.Display.blit(ItemsText, ((self.realWidth-ItemsTextWidth)-2, 450*yScaleFact))
                    if hover6 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(SpecialItemsTextWidth+SelectorWidth)-2, 500*yScaleFact))
                        
                    self.Display.blit(SpecialItemsText, ((self.realWidth-SpecialItemsTextWidth)-2, 500*yScaleFact))
                    if hover7 == True: 
                        AlphaSurface.blit(Selector, (self.realWidth-(ItemsTextWidth+SelectorWidth)-2, 450*yScaleFact))

                    self.Display.blit(OptionsText, ((self.realWidth-OptionsTextWidth)-2, 550*yScaleFact))
                    if hover8 == True:
                        AlphaSurface.blit(Selector, (self.realWidth-(OptionsTextWidth+SelectorWidth)-2, 550*yScaleFact))
