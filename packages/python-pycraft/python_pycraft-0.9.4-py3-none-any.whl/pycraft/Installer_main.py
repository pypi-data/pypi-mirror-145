...
class RunInstaller:
    def __init__(InstallerImportData):
        ...
        if "site-packages" in InstallerImportData.base_folder or "dist-packages" in InstallerImportData.base_folder:
            ...
            from pycraft import InstallerUtil
            InstallerImportData.mod_InstallerUtil__ = InstallerUtil
    ...
    def Initialize():
        ...
        PycPath = InstallerImportData.mod_InstallerUtil__.GetInstallerData.GetData(InstallerImportData)
