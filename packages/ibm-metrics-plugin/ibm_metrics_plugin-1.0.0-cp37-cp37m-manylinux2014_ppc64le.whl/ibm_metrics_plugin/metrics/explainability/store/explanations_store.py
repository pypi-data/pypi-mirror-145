...
class ExplanationsStore():
    ...
    def get_explanations(self, count):
        return self.data_store.get_explanations(count=count)
    ...
    @staticmethod
    def get_explanations_schema(include_record_id=True):
        ...
        if include_record_id:
            fields.append(StructField("record_id", StringType(), False))
...
class HiveDataStore(DataStore):
    ...
    def get_explanations(self, count):
        ...
        explanations_query = "SELECT {} FROM {}.{} TABLESAMPLE ({} ROWS)".format(
            "explanation", self.data_table.db, self.data_table.table, count)
...
class JdbcDataStore(DataStore):
    ...
    def get_explanations(self, count):
        ...
        explanations_query = "SELECT {} FROM \"{}\".\"{}\" TABLESAMPLE ({} ROWS)".format(
            "explanation", self.data_table.schema, self.data_table.table, count)
        self.logger.log_info("Executing query {}.".format(explanations_query))
