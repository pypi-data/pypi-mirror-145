...
class POSSetting(BaseNModel,DictModel):
    ...
    def setting(self):
        ...
        return {
                ...
                #'outlet_id'                         : outlet.id,    
                #'outlet_company_name'               : outlet.company_name,
                #'outlet_business_reg_no'            : outlet.business_reg_no,
                #'outlet_address'                    : outlet.address,
                #'outlet_email'                      : outlet.email,
                #'outlet_phone'                      : outlet.office_phone,
                'website'                           : merchant_acct.website,
...
class DinningOption(BaseNModel,DictModel):
    ...
    dict_properties = ['name','is_archive', 'is_default', 'dinning_table_is_required', 'assign_queue']
    
    @staticmethod
    def create(name, merchant_acct, is_default=False, dinning_table_is_required=False, assign_queue=False):
    ...
    @staticmethod
    def update(dinning_option, name, is_default=False, dinning_table_is_required=False, assign_queue=False):
