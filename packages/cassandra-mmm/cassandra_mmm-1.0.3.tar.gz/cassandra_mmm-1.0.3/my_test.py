...
hyperparameters_dict = instrum_variables_nevergrad(media, organic, force_coeffs=True, use_intercept=True, use_adstock=True,
                                                   use_saturation=True, adstock_type='weibull')
#hyperparameters_dict['ridge_number'] = {'lower': 0, 'upper': None}

metric, result, model, coeff, metric_array = nevergrad_model(df, hyperparameters_dict, media, organic, 'conversions',
                                                             model_regression='logLog', model_regression_log_log='ridge',
