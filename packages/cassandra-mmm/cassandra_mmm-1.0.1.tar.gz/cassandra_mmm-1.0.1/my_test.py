...
hyperparameters_dict = instrum_variables_nevergrad(media, organic)

metric, result, model, metric_array = nevergrad_model(df, hyperparameters_dict, media, organic, 'conversions')
