...
def nevergrad_model(df, hyperparameters_dict, medias, organic, target, use_intercept=True, use_adstock=True, use_saturation=True,
    ...
    def build_model(df, df_transformations, value_trasf, medias, organic, hyperparameters_dict):
    ...
    def build_model_result(df, df_transformations, value_trasf, medias, organic, hyperparameters_dict):
