...
setup(
    ...
    # For my project, I have only one - "raghav".
    ...
    description="Test String Manip Functions",
    ...
    # This field is OPTIONAL
    #url="https://github.com/raghav/test",

    # The author name and email fields are self explanatory.
    # These fields are OPTIONAL
    author_name="raghav",
    author_email="raghav.thapa@datadoghq.com",
    ...
    # This field is OPTIONAL
    keywords="string, manipulation, test",
