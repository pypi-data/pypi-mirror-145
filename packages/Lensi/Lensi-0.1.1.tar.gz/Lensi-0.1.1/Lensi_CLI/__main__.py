    ...
    def uninstall(self,app_name,app_source="web"):
        if app_source == "web":
            ...
            try:
                ...
                pass
        elif app_source == "S" or app_source == "scoop" or app_source == "s":
            Scoop_uninstall_app(app_name)
        elif app_source == "C" or app_source == "Choco" or app_source == "c":
            choco_uninstall_app(app_name)
        elif app_source == "W" or app_source == "Winget" or app_source == "w":
