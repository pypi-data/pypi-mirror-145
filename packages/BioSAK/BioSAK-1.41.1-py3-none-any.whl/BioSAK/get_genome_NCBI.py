...
# Example commands
BioSAK get_genome_NCBI -csv prokaryotes.csv -out op_dir -name -t 8 -fna 
BioSAK get_genome_NCBI -csv prokaryotes.csv -out op_dir -name -t 8 -fna -faa 
BioSAK get_genome_NCBI -csv prokaryotes.csv -out op_dir -name -t 8 -fna -gbff -id assembly_ids.txt
