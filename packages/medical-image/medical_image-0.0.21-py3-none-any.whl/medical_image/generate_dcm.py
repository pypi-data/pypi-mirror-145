...
class DicomModule(object):
    ...
    def make_sc_array(self, result_json):
        ...
        img_editable.text((x + shadow, y + result_json['Height'] * 0.001 + logo_h + shadow), msg, (167, 167, 167), mfont)
        img_editable.text((x, y + result_json['Height'] * 0.001 + logo_h), msg, (255, 255, 255), mfont)
