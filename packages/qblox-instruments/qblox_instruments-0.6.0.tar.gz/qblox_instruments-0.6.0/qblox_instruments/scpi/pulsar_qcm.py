...
class PulsarQcm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.6.3 fwBuild=14/12/2021-13:34:48 fwHash=0xB975958 fwDirty=1 kmodVersion=0.7.0 kmodBuild=25/03/2022-13:22:48 kmodHash=0x248C9EE0 kmodDirty=0 swVersion=0.7.0 swBuild=25/03/2022-13:22:48 swHash=0x248C9EE0 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=25/03/2022-13:22:48 cfgManHash=0x248C9EE0 cfgManDirty=0"
            if build != build_ref:
