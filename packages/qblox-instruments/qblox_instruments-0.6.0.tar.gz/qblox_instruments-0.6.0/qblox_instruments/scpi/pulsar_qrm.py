...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.6.3 fwBuild=17/12/2021-12:28:39 fwHash=0x39EDEDA fwDirty=0 kmodVersion=0.7.0 kmodBuild=25/03/2022-13:23:21 kmodHash=0xBF1A5EDC kmodDirty=0 swVersion=0.7.0 swBuild=25/03/2022-13:23:21 swHash=0xBF1A5EDC swDirty=0 cfgManVersion=0.2.0 cfgManBuild=25/03/2022-13:23:21 cfgManHash=0xBF1A5EDC cfgManDirty=0"
            if build != build_ref:
