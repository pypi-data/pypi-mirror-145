...
def kmeans():
    ...
    txt = "import numpy as np \n"\
        ...
        "mtp.scatter(x[y_predict == 0, 0], x[y_predict == 0, 1], label='cluster1')\n"\
        "mtp.scatter(x[y_predict == 1, 0], x[y_predict == 1, 1], label='cluster2')\n"\
        "mtp.scatter(x[y_predict == 2, 0], x[y_predict == 2, 1], label='cluster3')\n"\
        "mtp.scatter(x[y_predict == 3, 0], x[y_predict == 3, 1], label='cluster4')\n"\
        "mtp.scatter(x[y_predict == 4, 0], x[y_predict == 4, 1], label='cluster5')\n"\
        "mtp.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1], label='Centroids')\n"\
        "plt.xlabel('latitude')\n"\
