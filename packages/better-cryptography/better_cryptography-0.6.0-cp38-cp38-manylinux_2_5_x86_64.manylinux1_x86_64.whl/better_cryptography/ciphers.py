...
class Ciphers: # tested
    ...
    def AES_encrypt_string(self, string_to_encrypt:bytes, key=None or bytes):  # tested
        """
...
def init_diagonostic():
    ...
    # encrypting a string
    encrypted_string, iv, key = cipher.AES_encrypt_string("Hello World")
    # decrypting the string
    ...
    with open("test_file.txt", "r") as f:
        assert f.read() == "Hello World"
    # encrypting a string
    encrypted_string, iv, key = cipher.BLO_encrypt_string("Hello World")
    # decrypting the string
    ...
    # using prev test file
    # encrypting the file
    cipher.FerNet_encrypt_file("test_file.txt")
    # decrypting the file
    cipher.FerNet_decrypt_file("test_file.txt")
    # checking if the file is decrypted
    with open("test_file.txt", "r") as f:
        assert f.read() == "Hello World"
    # encrypting a string
    encrypted_string = cipher.FerNet_encrypt_string("Hello World")
    # decrypting the string
    decrypted_string = cipher.FerNet_decrypt_string(encrypted_string)
    # checking if the decrypted string is the same as the original
    assert decrypted_string.decode() == "Hello World"
    print ("test complete; Fernet methods passed")
    print ("All tests completed | All tests passed")
