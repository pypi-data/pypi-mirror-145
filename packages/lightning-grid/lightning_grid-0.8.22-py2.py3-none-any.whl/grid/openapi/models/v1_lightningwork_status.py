...
class V1LightningworkStatus(object):
    ...
    def __init__(self, last_state_status_transition_timestamp: 'datetime' = None, message: 'str' = None, phase: 'V1LightningworkState' = None, reason: 'V1LightningworkStatusReason' = None, start_timestamp: 'datetime' = None, stop_timestamp: 'datetime' = None, _configuration=None):  # noqa: E501
