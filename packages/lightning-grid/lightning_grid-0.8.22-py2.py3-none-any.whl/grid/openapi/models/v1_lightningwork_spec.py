...
class V1LightningworkSpec(object):
    ...
    attribute_map = {
        ...
        'lightningapp_id': 'lightningappId',
    ...
    def __init__(self, build_spec: 'V1BuildSpec' = None, cluster_id: 'str' = None, compute_config: 'V1ComputeConfig' = None, desired_state: 'V1LightningworkState' = None, lightningapp_id: 'str' = None, network_config: 'list[V1NetworkConfig]' = None, pause_automation: 'bool' = None, user_id: 'str' = None, user_requested_compute_config: 'V1UserRequestedComputeConfig' = None, _configuration=None):  # noqa: E501
        ...
        if lightningapp_id is not None:
            self.lightningapp_id = lightningapp_id
    ...
    @property
    def lightningapp_id(self) -> 'str':
        """Gets the lightningapp_id of this V1LightningworkSpec.  # noqa: E501


        :return: The lightningapp_id of this V1LightningworkSpec.  # noqa: E501
        :rtype: str
        """
        return self._lightningapp_id

    @lightningapp_id.setter
    def lightningapp_id(self, lightningapp_id: 'str'):
        """Sets the lightningapp_id of this V1LightningworkSpec.


        :param lightningapp_id: The lightningapp_id of this V1LightningworkSpec.  # noqa: E501
        :type: str
        """

        self._lightningapp_id = lightningapp_id
