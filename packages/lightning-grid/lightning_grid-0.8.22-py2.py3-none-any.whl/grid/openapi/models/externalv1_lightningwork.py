...
class Externalv1Lightningwork(object):
    ...
    def __init__(self, created_at: 'datetime' = None, id: 'str' = None, name: 'str' = None, project_id: 'str' = None, spec: 'V1LightningworkSpec' = None, status: 'V1LightningworkStatus' = None, updated_at: 'datetime' = None, _configuration=None):  # noqa: E501
