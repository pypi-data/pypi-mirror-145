...
class Body10(object):
    ...
    swagger_types = {
        ...
        'work_requests': 'list[V1WorkRequest]'
    }
    ...
    def __init__(self, description: 'str' = None, local_source: 'bool' = None, name: 'str' = None, spec: 'V1LightningappSpec' = None, work_requests: 'list[V1WorkRequest]' = None, _configuration=None):  # noqa: E501
    ...
    def local_source(self) -> 'bool':
        """Gets the local_source of this Body10.  # noqa: E501
        ...
        :return: The local_source of this Body10.  # noqa: E501
        :rtype: bool
        """
    ...
    def local_source(self, local_source: 'bool'):
        """Sets the local_source of this Body10.

        Indicates that the client wishes to upload the directory that has the source code. In this case, app's status is populated with the presigned URL and the app's spec is set by the server to the S3 tarball that holds the sourcecode.  # noqa: E501

        :param local_source: The local_source of this Body10.  # noqa: E501
        :type: bool
        """
    ...
    def spec(self) -> 'V1LightningappSpec':
        """Gets the spec of this Body10.  # noqa: E501


        :return: The spec of this Body10.  # noqa: E501
    ...
    def spec(self, spec: 'V1LightningappSpec'):
        """Sets the spec of this Body10.


        :param spec: The spec of this Body10.  # noqa: E501
    ...
    @property
    def work_requests(self) -> 'list[V1WorkRequest]':
        """Gets the work_requests of this Body10.  # noqa: E501


        :return: The work_requests of this Body10.  # noqa: E501
        :rtype: list[V1WorkRequest]
        """
        return self._work_requests

    @work_requests.setter
    def work_requests(self, work_requests: 'list[V1WorkRequest]'):
        """Sets the work_requests of this Body10.


        :param work_requests: The work_requests of this Body10.  # noqa: E501
        :type: list[V1WorkRequest]
        """
