...
class V1ProjectComputeDailyUsage(object):
    ...
    def __init__(self, _date: 'datetime' = None, total_cost_experiments: 'float' = None, total_cost_sessions: 'float' = None, usage: 'list[V1ProjectComputeUsage]' = None, _configuration=None):  # noqa: E501
