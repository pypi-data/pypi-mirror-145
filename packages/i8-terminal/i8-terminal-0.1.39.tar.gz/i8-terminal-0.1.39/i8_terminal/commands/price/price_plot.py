...
def get_data_df(
    ...
    rename_cols = {"close": "Close", "open": "Open", "high": "High", "low": "Low", "volume": "Volume"}
...
def create_fig(
    ...
    fig = make_subplots(
        ...
        row_width=row_width,
        specs=[[{"secondary_y": True}], (rows_num - 1) * [{"secondary_y": True}]],
    )
    if chart_type == "candlestick":
        ...
        fig.add_trace(
            go.Bar(x=df.index, y=df["Volume"], name="Volume", opacity=0.3, showlegend=False), secondary_y=True
        )
