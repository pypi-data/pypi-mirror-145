...
GETTER_PERMS = [Permission.VIEWER.name, Permission.COOWNER.name, Permission.EDITOR.name]
PUTTER_PERMS = [Permission.EDITOR.name, Permission.COOWNER.name]
DELETER_PERMS = PUTTER_PERMS
POSTER_PERMS = PUTTER_PERMS
