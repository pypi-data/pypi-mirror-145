...
def status_not_found(body: Optional[bytes] = None) -> web.Response:
    """
...
def status_multiple_choices(default_url: Union[URL, str], body: Optional[bytes] = None, content_type: str = 'application/json') -> web.Response:
    """
...
def status_bad_request(body: Optional[bytes] = None) -> web.Response:
    """
...
def status_ok(body: Optional[bytes], content_type: str = 'application/json') -> web.Response:
    """
