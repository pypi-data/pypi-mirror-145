...
class TestExecutor:
    ...
    def runTestAssertTransformed(self,
        ...
        results_Z = self.runTestAssertProbability(qc, nbTrials, nbMeasurements, qu0, measuredBit, "z", backend)
        results_Y = self.runTestAssertProbability(qc_Y, nbTrials, nbMeasurements, qu0, measuredBit, "y", backend)
        results_X = self.runTestAssertProbability(qc_X, nbTrials, nbMeasurements, qu0, measuredBit, "x", backend)
