...
class QiskitPropertyTest():
    ...
    INPUTS:
        ...
        - backend: str = backend the will execute the tests
            (not an actual backend object, just a string that will choose the appropriate aer backend or ibmq)
    ...
    OUTPUTS:
        - List of the results for each test:
            ...
            the thetas and the phis used to initialise the first and the second qubits
    """
    def assertEntangledData(self, qu0, qu1, basis, backend, filter_qc):
    ...
    OUTPUTS:
        - List of the results for each test:
            ...
            the thetas and the phis used to initialise the first and the second qubits
    """
    def assertEntangled(self, qu0, qu1, basis="z", backend="aer_simulator", filter_qc=None):
        results = self.assertEntangledData(qu0, qu1, basis, backend, filter_qc)
    ...
    def assertNotEntangled(self, qu0, qu1, basis="z", backend="aer_simulator", filter_qc=None):
        oppositeResults = self.assertEntangledData(qu0, qu1, basis, backend, filter_qc)
    ...
    def assertTeleportedData(self, sent, received, basis, backend, filter_qc):
    ...
    def assertTeleported(self, sent, received, basis="z", backend="aer_simulator", filter_qc=None):
        results = self.assertTeleportedData(sent, received, basis, backend, filter_qc)
    ...
    def assertNotTeleported(self, sent, received, basis="z", backend="aer_simulator", filter_qc=None):
        oppositeResults = self.assertTeleportedData(sent, received, basis, backend, filter_qc)
    ...
    def assertStateData(self, qu0, theta, phi, isRadian, qu0_pre, filter_qc, backend):
    ...
    def assertState(self, qu0, theta, phi, isRadian=False, qu0_pre=False, filter_qc=None, backend="aer_simulator"):

        results = self.assertStateData(qu0, theta, phi, isRadian, qu0_pre, filter_qc, backend)
    ...
    def assertNotState(self, qu0, theta, phi, isRadian=False, qu0_pre=False, filter_qc=None, backend="aer_simulator"):

        oppositeResults = self.assertStateData(qu0, theta, phi, isRadian, qu0_pre, filter_qc, backend)
