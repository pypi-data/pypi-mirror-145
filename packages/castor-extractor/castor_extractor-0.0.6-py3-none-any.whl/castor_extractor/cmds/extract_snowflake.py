...
from castor_extractor.warehouse.snowflake import extract_all  # type: ignore
...
def main():
    ...
    parser.add_argument("--role", help="Use a specific ROLE to run extraction queries")

    parser.add_argument(
        "--db-allowed", nargs="*", help="List of databases that should be extracted"
    )
    parser.add_argument(
        "--db-blocked",
        nargs="*",
