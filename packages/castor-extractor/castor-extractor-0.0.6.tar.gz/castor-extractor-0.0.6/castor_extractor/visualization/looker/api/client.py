...
class ApiClient:
    ...
    def folders(self, per_page: int = PER_PAGE) -> List[Folder]:
        ...
        return Pager(_search, logger=self._logger).all(per_page=per_page)

    def dashboards(self, per_page: int = PER_PAGE) -> List[Dashboard]:
    ...
    def looks(self, per_page: int = PER_PAGE) -> List[Look]:
    ...
    def users(self, per_page: int = PER_PAGE) -> List[User]:
