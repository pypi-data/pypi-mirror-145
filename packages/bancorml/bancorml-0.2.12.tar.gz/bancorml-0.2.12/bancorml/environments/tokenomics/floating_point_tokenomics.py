...
class FloatingPointTokenomics(TokenomicsBase):
    ...
    def check_balanced(self, a, e, is_surplus=False, is_deficit=True, is_balanced=False):
        if a == e:
            is_balanced, is_deficit, is_surplus = True, False, False
        self.is_balanced, self.surplus, self.deficit, self.hlim, self.satisfies_hlim, self.hmax, self.satisfies_hmax = is_balanced, is_surplus, is_deficit, np.nan, np.nan, np.nan, np.nan
