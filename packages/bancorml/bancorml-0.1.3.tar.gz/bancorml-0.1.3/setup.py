...
setup(
    name='bancorml',
    version='0.1.3', #major.minor.patch.databricks-runtime.initial-mlflow-model-version
    ...
    url='https://gcode-ai@dev.azure.com/gcode-ai/BancorML',
