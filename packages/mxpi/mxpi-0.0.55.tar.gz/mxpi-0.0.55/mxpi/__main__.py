...
def main():
    ...
    console = Console()
    #console.print("Welcome to MxPi(0.0.55)!:smiley:",style="bold red")
    console.print("Welcome to MxPi(0.0.55)!:smiley:   System:"+platform.system()+"   IP: "+ip+":"+post,style="bold red")
