...
class pose():
    ...
    def _download_oss_pose_landmark_model(self,model_complexity):
        ...
        if model_complexity == 0:
            self.download_oss_model('modules/pose_landmark/pose_landmark_lite.tflite','https://gitcode.net/q924257/mediapipe-title/raw/master/pose_landmark_lite.tflite')
        elif model_complexity == 2:
            self.download_oss_model('modules/pose_landmark/pose_landmark_heavy.tflite','https://gitcode.net/q924257/mediapipe-title/raw/master/pose_landmark_heavy.tflite')

    
    def download_oss_model(self,model_path: str,down_url):
        ...
        os.system('sudo wget '+model_url+' --output-documen='+model_abspath)
        print('sudo wget '+model_url+' --output-documen='+model_abspath)
