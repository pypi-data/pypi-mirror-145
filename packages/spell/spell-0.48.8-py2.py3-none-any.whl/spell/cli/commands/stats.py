...
def print_stats(run_id, cpu_stats, gpu_stats, raw=False, clear=False):
    ...
    if raw:
        ...
        cpu_stats.mem_ratio = "{} / {}".format(prettify_size(cpu_stats.memory), prettify_size(cpu_stats.memory_total))
        cpu_stats.net_ratio = "{} / {}".format(prettify_size(cpu_stats.network_rx), prettify_size(cpu_stats.network_tx))
