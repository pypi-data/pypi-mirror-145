...
class RdClient(MsSqlClient):
    def __init__(self,token):
        ...
        MsSqlClient.__init__(self,ip=ip,user_name=user_name,password=password,db_name=db_name)
        ...
        if ncount >0:
            ...
            MsSqlClient.__init__(self, ip=self.ip, user_name=self.user_name, password=self.password, db_name=self.db_name)
if __name__ == '__main__':
    app = RdClient(token="75CE5B94-38F1-40F6-9B7B-9B4170C8E5F6")
