...
def augmentdf(df, datatype):
    ...
    Note the sqrt(3) is necessary because seaborn calculates the standard
    deviation from the augmented data (the mean, the mean + std, and the
    mean - std) and so would get std/sqrt(3) because there are three data
    points.
    """
