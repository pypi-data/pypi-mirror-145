...
from pwed.protocols import ProtImportDiffractionImages, EdBaseProtocol
...
class TestEdBaseProtocol(TestEdBase):
    def getTestStr(self):
    ...
    def test_str2floatList(self):
        output = EdBaseProtocol.str2floatList(self, self.getTestStr())
        self.assertEqual(output, self.getFloatList())

    def test_str2intList(self):
        output = EdBaseProtocol.str2intList(self, self.getTestStr())
        self.assertEqual(output, self.getIntList())

    def test_list2str(self):
        floatOutput = EdBaseProtocol.list2str(self, self.getFloatList())
        intOutput = EdBaseProtocol.list2str(self, self.getIntList())
        self.assertEqual(floatOutput, self.getFloatStr())
        self.assertEqual(intOutput, self.getIntStr())

    def test_fixString(self):
        fixed = EdBaseProtocol.fixString(self, self.getTestStr())
        self.assertEqual(fixed, self.getIntStr())
