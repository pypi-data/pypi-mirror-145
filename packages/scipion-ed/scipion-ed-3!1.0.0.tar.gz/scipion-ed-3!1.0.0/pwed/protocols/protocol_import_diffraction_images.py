...
class ProtImportDiffractionImages(EdBaseProtocol):
    ...
    def _defineParams(self, form):
        ...
        form.addParam('filesPattern', pwprot.StringParam,
                      label='Pattern',
                      # default based on instamatic
                      default="SMV/data/{TI}.img",
                      help="Pattern of the experiment\n\n"
                           ...
                           "   {TI}: image identifier "
                           "         (an integer value, unique within the"
                           " experiment).\n"
                           "Examples:\n"
                           "")
        ...
        form.addParam('replaceRotationAxis', pwprot.BooleanParam,
                      ...
                      help=("The rotation axis is an instrument parameter. If"
                            "the correct parameter is not given automatically,"
                            "it might need to be overwritten here."),
                      expertLevel=pwprot.LEVEL_ADVANCED,
                      )
        ...
        form.addParam('rotationAxis', pwprot.StringParam, default=None,
                      allowsNull=True,
                      label="Rotation axis",
                      help=("The goniometer rotation axis relative to "
                            "the image."),
        ...
        group.addParam('useTemplate', pwprot.BooleanParam,
                       ...
                       help=("Explicitly set a template syntax to use for "
                             "DIALS import or XDS input file"),
                       )
        group.addParam('tsReplacement', pwprot.StringParam,
                       label='String to insert instead of {TI}',
                       default='00###',
                       help=("Only useful in XDS or when using template in"
                             " DIALS."),
                       )
        ...
        group.addParam('overwriteWavelength', pwprot.StringParam,
                       ...
                       help=("Use this value instead of the value found in the"
                             " file header.")
                       )
        ...
        group.addParam('overwriteDetectorDistance', pwprot.StringParam,
                       ...
                       help=("Use a different detector distance than found in"
                             " the file header.")
                       )
        ...
        group.addParam('overwritePixelSize', pwprot.StringParam,
                       ...
                       help=("Overwrites the pixel size found from the"
                             " headerfile.")
                       )
        ...
        group.addParam('overwriteExposureTime', pwprot.StringParam,
                       ...
                       help=("Overwrites the exposure time found from the"
                             " headerfile.")
                       )
        ...
        group.addParam('overwriteOscStart', pwprot.StringParam,
                       ...
                       help=("Overwrites the starting angle found from the"
                             " headerfile.")
                       )
        ...
        group.addParam('overwriteOscRange', pwprot.StringParam,
                       ...
                       help=("Overwrites the oscillation range found from the"
                             " headerfile.")
                       )
        ...
        group.addParam('overwriteBeamCenterX', pwprot.StringParam,
                       ...
                       help=("Overwrites the beam center X found from the"
                             " headerfile.")
                       )
        ...
        group.addParam('overwriteBeamCenterY', pwprot.StringParam,
                       ...
                       help=("Overwrites the beam center Y found from the"
                             " headerfile.")
                       )
