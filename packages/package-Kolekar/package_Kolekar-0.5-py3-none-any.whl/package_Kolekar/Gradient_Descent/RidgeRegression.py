...
class RidgeRegressionModel:
      def __init__(self,learning_rate,max_iter,l2_penalty):
          """
      ...
      def update_weights(self):
          ...
          self.dw = (2/self.m)*(-self.X.T.dot(self.y-self.y_pred)+self.w*self.l2_penalty)
...
print(RidgeRegressionModel.__doc__)