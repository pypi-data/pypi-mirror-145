...
class ElasticNetRegressionModel:
      def __init__(self,learning_rate,max_iter,l1_penalty,l2_penalty):
          """
            Return with Learning Rate and max_iter.
                 ...
                 l2_penality    (int)  = range varies from (1e-15,1)
            Parameters:
            -----------
      ...
      def upload_weights(self):
          ...
          self.dw = (2/self.m)*(-self.X.T.dot(self.y-self.y_pred)+self.l2_penalty*self.w+self.l1_penalty)
...
print(ElasticNetRegressionModel.__doc__)