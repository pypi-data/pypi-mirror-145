...
def generate_ranks_from_s_vals(s_vals):
    """
    Given a list of singular values, this function returns the list of
    ranks corresponding to the singular values.
...
def mean_fractional_entropy(y_amp):
    """
    Given a list of amplitudes, this function returns the mean fractional
    entropy of the amplitudes.
...
def state_fidelity(statevec_a, statevec_b):
    """
    Given two statevectors, this function returns the state fidelity.
