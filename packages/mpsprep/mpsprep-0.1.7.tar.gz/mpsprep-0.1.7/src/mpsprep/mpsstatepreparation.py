...
class LocalMPSTensor:
    ...
    def to_right_matrix(self, order="F"):
        ...
        ----------
        order : str
            The order of the matrix. Either "C" or "F". Default is "F".
...
class MatrixProductState:
    ...
    def plot_singular_values(s_vals, subplot_kwargs=None, yscale="log",
        ...
        """
        Plot the singular values of a MPS.
...
class MatrixProductInitializer:
    ...
    def _to_full_space(self, core_pos, gate_unitary):
        ...
        ----------
        core_pos : int
            The zero based index of the MPS core that gate_unitary
            corresponds to.
    ...
    def nqubit_gate(core):
        """
        Returns the unitary matrix for the nqubit gate.
        ...
        -------
        U : np.ndarray
            The unitary matrix for the nqubit gate.
        """
        N = int(np.ceil(np.log2(core.left_bond_dim)))
        M = int(np.ceil(np.log2(core.right_bond_dim)))
    ...
    def num_MPS_qubits(self):
        """
        Returns the number of qubits in the MPS.
    ...
    def num_ancilla_qubits(self):
        """
        Returns the number of ancilla qubits in the MPS.

        Returns
        -------
        num_ancilla_qubits : int
            The number of ancilla qubits in the MPS.
        """
    ...
    def is_unitary(matrix, rtol=1e-5, atol=1e-8, equal_nan=False):
        ...
        equal_nan : bool
            Whether to treat NaN's as equal. Default is False.
    ...
    def gate_unitary(self):
        """
        Returns the full gate unitary of the MPS.

        Returns
        -------
        gate_unitary : np.ndarray
            The gate unitary of the MPS.
        """
