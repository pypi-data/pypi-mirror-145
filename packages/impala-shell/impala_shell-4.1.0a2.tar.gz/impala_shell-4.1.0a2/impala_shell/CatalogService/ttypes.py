...
class TTableInfoSelector(object):
    ...
    def __init__(self, want_hms_table=None, partition_ids=None, want_partition_names=None, want_partition_metadata=None, want_partition_files=None, want_stats_for_column_names=None, want_partition_stats=None, want_table_constraints=None, valid_write_ids=None, table_id=-1, want_stats_for_all_columns=None, want_hms_partition=None, want_iceberg_snapshot=None,):
        ...
        self.want_iceberg_snapshot = want_iceberg_snapshot
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.want_iceberg_snapshot = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.want_hms_partition is not None:
            ...
            oprot.writeFieldEnd()
        if self.want_iceberg_snapshot is not None:
            oprot.writeFieldBegin('want_iceberg_snapshot', TType.BOOL, 13)
            oprot.writeBool(self.want_iceberg_snapshot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TIcebergSnapshot(object):
    """
    Attributes:
     - snapshot_id
     - iceberg_file_desc_map
    """


    def __init__(self, snapshot_id=None, iceberg_file_desc_map=None,):
        self.snapshot_id = snapshot_id
        self.iceberg_file_desc_map = iceberg_file_desc_map
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.iceberg_file_desc_map = {}
                    (_ktype103, _vtype104, _size102) = iprot.readMapBegin()
                    for _i106 in range(_size102):
                        _key107 = iprot.readString()
                        _val108 = CatalogObjects.ttypes.THdfsFileDesc()
                        _val108.read(iprot)
                        self.iceberg_file_desc_map[_key107] = _val108
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TIcebergSnapshot')
        if self.snapshot_id is not None:
            oprot.writeFieldBegin('snapshot_id', TType.I64, 1)
            oprot.writeI64(self.snapshot_id)
            oprot.writeFieldEnd()
        if self.iceberg_file_desc_map is not None:
            oprot.writeFieldBegin('iceberg_file_desc_map', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.iceberg_file_desc_map))
            for kiter109, viter110 in self.iceberg_file_desc_map.items():
...
class TPartialTableInfo(object):
    ...
    def __init__(self, hms_table=None, partitions=None, column_stats=None, storage_metadata_load_time_ns=None, network_addresses=None, sql_constraints=None, valid_write_ids=None, is_marked_cached=None, partition_prefixes=None, iceberg_snapshot=None,):
        ...
        self.iceberg_snapshot = iceberg_snapshot
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i115 in range(_size111):
                        _elem116 = TPartialPartitionInfo()
                        _elem116.read(iprot)
                        self.partitions.append(_elem116)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i121 in range(_size117):
                        _elem122 = hive_metastore.ttypes.ColumnStatisticsObj()
                        _elem122.read(iprot)
                        self.column_stats.append(_elem122)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i127 in range(_size123):
                        _elem128 = Types.ttypes.TNetworkAddress()
                        _elem128.read(iprot)
                        self.network_addresses.append(_elem128)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i133 in range(_size129):
                        ...
                        self.partition_prefixes.append(_elem134)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.STRUCT:
                    self.iceberg_snapshot = TIcebergSnapshot()
                    self.iceberg_snapshot.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.partitions is not None:
            ...
            for iter135 in self.partitions:
                iter135.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_stats is not None:
            ...
            for iter136 in self.column_stats:
                iter136.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.network_addresses is not None:
            ...
            for iter137 in self.network_addresses:
                iter137.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.partition_prefixes is not None:
            ...
            for iter138 in self.partition_prefixes:
                oprot.writeString(iter138)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.iceberg_snapshot is not None:
            oprot.writeFieldBegin('iceberg_snapshot', TType.STRUCT, 12)
            self.iceberg_snapshot.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPartialDbInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        _elem144 = TBriefTableMeta()
                        _elem144.read(iprot)
                        self.brief_meta_of_tables.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i149 in range(_size145):
                        ...
                        self.function_names.append(_elem150)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.brief_meta_of_tables is not None:
            ...
            for iter151 in self.brief_meta_of_tables:
                iter151.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.function_names is not None:
            ...
            for iter152 in self.function_names:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i157 in range(_size153):
                        _elem158 = Types.ttypes.TFunction()
                        _elem158.read(iprot)
                        self.functions.append(_elem158)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetPartitionStatsResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i164 in range(_size160):
                        ...
                        self.partition_stats[_key165] = _val166
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_stats is not None:
            ...
            for kiter167, viter168 in self.partition_stats.items():
                oprot.writeString(kiter167)
                oprot.writeBinary(viter168)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPrioritizeLoadRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i173 in range(_size169):
                        _elem174 = CatalogObjects.ttypes.TCatalogObject()
                        _elem174.read(iprot)
                        self.object_descs.append(_elem174)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.object_descs is not None:
            ...
            for iter175 in self.object_descs:
                iter175.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i180 in range(_size176):
                        _elem181 = TTableUsage()
                        _elem181.read(iprot)
                        self.usages.append(_elem181)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
TTableInfoSelector.thrift_spec = (
    ...
    (13, TType.BOOL, 'want_iceberg_snapshot', None, None, ),  # 13
)
...
all_structs.append(TIcebergSnapshot)
TIcebergSnapshot.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'snapshot_id', None, None, ),  # 1
    (2, TType.MAP, 'iceberg_file_desc_map', (TType.STRING, None, TType.STRUCT, [CatalogObjects.ttypes.THdfsFileDesc, None], False), None, ),  # 2
)
...
TPartialTableInfo.thrift_spec = (
    ...
    (12, TType.STRUCT, 'iceberg_snapshot', [TIcebergSnapshot, None], None, ),  # 12
)
