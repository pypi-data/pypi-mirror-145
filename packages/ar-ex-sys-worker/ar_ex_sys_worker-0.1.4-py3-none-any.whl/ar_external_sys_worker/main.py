...
class SignallActChecker(mixins.SignallMixin, DataWorker,
    ...
    def work(self, start_date: str, end_date: str,
        ...
        wdb_acts_info = self.get_wdb_tonnage(" time_in > '{}' and time_in::date <= '{}' and tc.{}='ТКО' ".format(start_date,end_date, self.tc_column_name))
        print(wdb_acts_info)
        ...
        if 'error' in act_send_response:
            ...
            return
        my_acts = self.get_acts_period(start_date, end_date, " and tc.{}='ТКО' and time_out is not null".format(self.tc_column_name))
