...
>
  ...
  ${e.icon}
    ...
    `}},{kind:"method",key:"_renderTab",value:function(){switch(this._curTab){case"tab-settings":return this._entry?this._settingsElementTag?i.dy`
      ...
      `]}}]}}),i.oi)},27322:(e,t,r)=>{"use strict";r.d(t,{R:()=>i});const i=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`},86853:(e,t,r)=>{var i={"./entity-settings-helper-tab":[85511,41985,51644,68200,49842,1548,49075,8167,12545,13701,89251,6131],"./entity-settings-helper-tab.ts":[85511,41985,51644,68200,49842,1548,49075,8167,12545,13701,89251,6131]};function n(e){if(!r.o(i,e))return Promise.resolve().then((()=>{var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=i[e],n=t[0];return Promise.all(t.slice(1).map(r.e)).then((()=>r(n)))}n.keys=()=>Object.keys(i),n.id=86853,e.exports=n}}]);
//# sourceMappingURL=2a4738fe.js.map