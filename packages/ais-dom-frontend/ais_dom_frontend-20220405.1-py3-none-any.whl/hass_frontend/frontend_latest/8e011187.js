...
>
  How we process your data
      ...
      <ha-card .header=${this.hass.localize("ui.panel.config.url.caption")}>
        <div class="card-content">
          ...
          ${this._showCustomInternalUrl?a.dy`
              ...
              `:""}
          ${!l||i&&i.startsWith("https://")&&(d=new URL(i).hostname,!Ce.test(d))?"":a.dy`
                  <ha-alert
    ...
    `}static get properties(){return{hass:{type:Object},isWide:{type:Boolean,value:!1},validating:{type:Boolean,value:!1},isValid:{type:Boolean,value:null},validateLog:{type:String,value:""},showAdvanced:Boolean}}}customElements.define("ha-config-section-core",Re);class Me extends((0,o.Z)(n.H3)){static get template(){return i.d`
