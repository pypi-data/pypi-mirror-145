...
class SpectrumFeatures(BaseEstimator, TransformerMixin):
    ...
    * 'n_transactions': number of transactions between the two nodes
    compute node features, as described in ??? User Guide.
    ...
    def fit(self, X, y=None):
        """
        Empty. Here for API compatibility reasons.
        """
        return self
    ...
    def transform(self, X):
        ...
        self.degG_ = int(self.n_output_features_ / 2)
        self.feature_names_in_ = self.degG_ * ["sigma1"] + self.degG_ * ["sigma2"]
