...
def mosaic_around_point_using_batches(x=None, y=None, size=None, batch_dict=None,
    ...
    batch_dict = load_batch_to_dict(batch_label, batch_dict,
                                    bucket=bucket, local_batches_dir=local_batches_dir)
    ...
    if batch_y_aux in [-1, 1]:
        ...
        batch_dict = load_batch_to_dict(batch_iter_label, batch_dict,
                                        bucket=bucket, local_batches_dir=local_batches_dir)
