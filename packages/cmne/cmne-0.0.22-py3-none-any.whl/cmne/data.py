        ...
        if os.path.exists(self._settings.data_path()) and \
           ...
           os.path.exists(self._settings.data_path() + 'assr_270LP_fs900_raw-test-idcs.txt') :
            ...
            if not os.path.exists(self._settings.data_path() + 'tmp/ASSR.zip'):
                retrieve(url='https://osf.io/jmu5v/download',
            ...
            os.system('mv ' + self._settings.data_path() + 'tmp/ASSR/assr_270LP_fs900_raw-test-idcs.fif ' + \
                              self._settings.data_path() + 'assr_270LP_fs900_raw-test-idcs.fif')
