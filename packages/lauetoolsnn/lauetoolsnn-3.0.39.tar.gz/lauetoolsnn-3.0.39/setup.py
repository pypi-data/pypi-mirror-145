...
setuptools.setup(
    ...
    install_requires=['matplotlib>=3.4.2', 'Keras>=2.4.3', 'numpy>=1.18.5', 'h5py>=2.10.0', 'tensorflow>=2.3.0', 'PyQt5>=5.9', 'scikit-learn>=0.24.2', 'fabio>=0.11.0', 'networkx>=2.6.3', 'scikit-image>=0.18.0','tqdm>=4.60.0'],
