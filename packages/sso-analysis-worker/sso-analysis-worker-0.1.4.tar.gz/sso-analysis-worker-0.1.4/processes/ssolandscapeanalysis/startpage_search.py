...
def get_startpage_login_pages(driver, base_page, count_of_results=1, login_search_term="login", max_tries=3,
    ...
    print("Starting Startpage search")
    ...
    print("Searching Startpage with term \"" + search_term + "\"")
    counter = 1
        ...
        try:
            ...
            while links_counter < count_of_results:
                try:
                    ...
                    if links_counter == 0:
                        print("Could not find any search result element.")
                        ...
                        if class_attr is not None and 'active' in class_attr.split():
                            ...
                            print("Family search was not the problem. Checking test search")
                            if not test_search(driver):
                                raise exceptions.StartPageHasChangedException()
                            print("Looks like no links are found by Startpage for the original request.")
