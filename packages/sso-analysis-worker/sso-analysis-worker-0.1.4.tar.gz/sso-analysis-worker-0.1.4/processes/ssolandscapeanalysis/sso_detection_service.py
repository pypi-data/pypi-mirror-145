...
class SSODetectionService:
    ...
    def automatic_sso_detection(self, chromedriver, latest_login_info, progress_callback=None, run_google=True,
        ...
        if run_google:
            ...
            print("--- Finished Google in " + str(round(time.time() - start_time, 2)) + "s ---")
        ...
        if run_facebook:
            ...
            print("--- Finished Facebook in " + str(round(time.time() - start_time, 2)) + "s ---")
        ...
        if run_apple:
            ...
            print("--- Finished Apple in " + str(round(time.time() - start_time, 2)) + "s ---")
