...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, sock_read_timeout=None, sock_connect_timeout=None, total_timeout=None, max_retries=None, headers=None, url=None, pulp_created=None, proxy_url=None, tls_validation=None, pulp_href=None, pulp_labels=None, connect_timeout=None, name=None, pulp_last_updated=None, download_concurrency=None, ca_cert=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
