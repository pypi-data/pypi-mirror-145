...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, password=None, client_cert=None, sock_read_timeout=None, proxy_username=None, sock_connect_timeout=None, total_timeout=None, max_retries=None, headers=None, username=None, url=None, proxy_url=None, tls_validation=None, pulp_labels=None, connect_timeout=None, name=None, client_key=None, download_concurrency=None, proxy_password=None, ca_cert=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
