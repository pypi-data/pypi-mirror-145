...
class TriggerFunction(
    ...
    def __init__(
        ...
        *,
        ...
        :param ephemeral_storage_size: (experimental) The size of the function’s /tmp directory in MB. Default: 512 MiB
...
class TriggerFunctionProps(_FunctionProps_5561697c, TriggerOptions):
    ...
    def ephemeral_storage_size(self) -> typing.Optional[_Size_7fbd4337]:
        '''(experimental) The size of the function’s /tmp directory in MB.
