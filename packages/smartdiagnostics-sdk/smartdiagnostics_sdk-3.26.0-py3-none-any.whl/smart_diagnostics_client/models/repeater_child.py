...
class RepeaterChild(object):
    ...
    attribute_map = {
        ...
        'repeater_node_count': 'RepeaterNodeCount'
    }

    def __init__(self, repeater_id=None, repeater_serial_number=None, repeater_name=None, repeater_node_count=None):  # noqa: E501
        ...
        self._repeater_node_count = None
        ...
        self.repeater_node_count = repeater_node_count
    ...
    @property
    def repeater_node_count(self):
        """Gets the repeater_node_count of this RepeaterChild.  # noqa: E501


        :return: The repeater_node_count of this RepeaterChild.  # noqa: E501
        :rtype: int
        """
        return self._repeater_node_count

    @repeater_node_count.setter
    def repeater_node_count(self, repeater_node_count):
        """Sets the repeater_node_count of this RepeaterChild.


        :param repeater_node_count: The repeater_node_count of this RepeaterChild.  # noqa: E501
        :type: int
        """
        if repeater_node_count is None:
            raise ValueError("Invalid value for `repeater_node_count`, must not be `None`")  # noqa: E501

        self._repeater_node_count = repeater_node_count
