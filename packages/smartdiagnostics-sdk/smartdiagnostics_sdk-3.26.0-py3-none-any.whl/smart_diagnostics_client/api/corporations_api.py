...
class CorporationsApi(object):
    ...
    def get_corporations(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Abbreviation` | String | `eq, neq, like, in` | | `AccessLevel` | AccessLevel | `eq, neq, in` | | `Active` | Boolean | `eq, neq` | | `Created` | DateTime | `eq, neq, in, lt, gt, leq, geq` | | `Id` | Guid | `eq, neq, in` | | `IndustryId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `Name` | String | `eq, neq, like, in` |
