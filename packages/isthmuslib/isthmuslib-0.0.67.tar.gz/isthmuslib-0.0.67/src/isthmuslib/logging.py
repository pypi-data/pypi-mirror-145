...
def extract_with_manual_tokens(input_string: str, tokens_dictionary: Dict[str, Tuple[str, str]], limit: int = None,
...
def extract_with_key_value_delimiters(input_string: str, left_token: str = None, key_value_delimiter: str = None,
...
def extract_with_embedded_json_unprocessed_dicts(input_string: str, embedded_json_line_prefix: str = None,
...
def extract_with_embedded_json(input_string: str, embedded_json_line_prefix: str = None,
    ...
    :param limit: maximum number of rows to process
    """
    extracted_json_dicts: List[Dict[str, Any]] = extract_with_embedded_json_unprocessed_dicts(
