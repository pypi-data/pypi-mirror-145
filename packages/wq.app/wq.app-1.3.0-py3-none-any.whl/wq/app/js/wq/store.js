...
var Store = /*#__PURE__*/function () {
    ...
    _createClass(Store, [{
        ...
        key: "addReducer",
        value: function addReducer(name, reducer, persist, restore) {
        ...
        value: function addEnhanceReducer(name, enhanceReducer, persist, restore) {
        ...
        key: "persistKey",
        value: function persistKey(name, persist, restore) {
            this._persistKeys.push(name);

            if (persist && restore) {
                this._transforms.push(reduxPersist.createTransform(persist, restore, {
                    whitelist: [name]
                }));
            }
        }
