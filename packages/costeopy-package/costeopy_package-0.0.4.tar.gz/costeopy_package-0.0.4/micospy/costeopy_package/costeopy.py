...
def cas(base,nombre_perfil,meses_perfil,monto_perfil,mes_12,mes_10,mes_inactivo_2):
...
def aguinaldo(base,nombre_perfil,veces_agui,monto_agui,mes_agui_2,mes_noagui_2):
...
def essalud(base,nombre_perfil,meses_perfil,mes_12,mes_10,mes_inactivo_2):
...
def total_perfil_mes(base,nombre,nombre_perfil,continuidad,mes_12):
