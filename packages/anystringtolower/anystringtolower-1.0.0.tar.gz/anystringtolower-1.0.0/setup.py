...
setup(
    ...
    version='1.0.0',
    description='Transform any string with accent and without accent to lower case',
    ...
    url='https://github.com/VolkenoMakers/anystringtolower',  # the URL of your package's home page e.g. github link
    author='VOLKENO',
