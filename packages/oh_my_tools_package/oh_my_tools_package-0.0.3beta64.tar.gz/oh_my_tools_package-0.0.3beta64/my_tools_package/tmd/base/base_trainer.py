...
class BaseTrainer:
    ...
    def __init__(self, i_fold, device, device_ids, model, optimizer, criterions, metric_ftns,  tmd_config):
        ...
        log_file = str(self.checkpoint_dir / f"{self.tmd_config.experiment_name}.log")
        self.logger = self.set_logger(self.tmd_config.trainer.log_level,log_file,self.tmd_config.trainer.log_level)
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if checkpoint['arch'] != self.tmd_config.model.type:
    ...
    def set_logger(self, log_level,log_file,log_file_level):
        return init_logger(log_level, log_file, log_file_level)
