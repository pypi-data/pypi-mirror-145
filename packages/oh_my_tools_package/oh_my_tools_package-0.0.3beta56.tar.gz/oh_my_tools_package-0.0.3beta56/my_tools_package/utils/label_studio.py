# -*- coding: utf-8 -*-
# @Time    : 2021/9/5 8:27 下午
# @Author  : jeffery
# @FileName: label_studio.py
    ...
    with input_file.open("r", encoding="utf8") as f:
        for idx, line in enumerate(f):
            ...
            all_data.append({
                ...
                "predictions": [],
                "meta": {},
                "created_at": '{}T{}Z'.format(time.strftime("%Y-%m-%d", time.localtime()), time.strftime("%H:%M:%S")),
                "updated_at": '{}T{}Z'.format(time.strftime("%Y-%m-%d", time.localtime()), time.strftime("%H:%M:%S")),
            })
...
if __name__ == '__main__':
    jsonl2labelstudio_ner(input_file=Path('/Users/lizhen/Downloads/train_500.jsonl'),out_file=Path('/Users/lizhen/Downloads/train_500_label_studio.jsonl'))