...
def mf(X, k, alg = 'PCA', display = True, verbose = 0):
    ...
    '''
    if (alg == 'PCA'): # in statistics, PCA is a factor extraction method for FA. 
    ...
    elif (alg == 'RP' or alg == 'GRP' or alg == 'SRP'):
...
def time(X, alg = 'PCA', display = True, r = list(range(1, 51)), repeat = 10):
    '''
