...
def generate_index_html(dirname,shuffle=False,encrypt=False):
    ...
    fimage = '<div class="item"><img src="{infojpg}" alt=" " data-src="{infojpg}"/></div>\n'	
    jpg_list = []
...
def main(dirname,time_interval,shuffle=False,delete_all_links=False,no_encrypt=False,endir=False,dedir=False,fix_ffmpeg=True,no_links=False):
