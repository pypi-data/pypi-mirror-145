...
def tutorial(ctx: click.core.Context, cfg: CLIContext, msg: bool, skip_dw: bool, drop_tables: bool) -> None:
    ...
    help_msg = textwrap.dedent(
        ...
        🤓 Please run the following steps,
          ...
          4. `mf query --metrics transactions_north_america_rolling_7 --dimensions ds --order ds` to access your first metric!
          4. `mf query --metrics transactions_north_america_rolling_7 --dimensions ds --order ds --explain` to how the query is constructed.
