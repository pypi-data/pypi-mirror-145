...
class DockerStats:
    ...
    def get_deltas(self, stats_prime: "DockerStats") -> Tuple[List[float], List[str]]:
        ...
        """
        deltas = [
            stats_prime.cpu_percent - self.cpu_percent,
            stats_prime.mem_current - self.mem_current,
            stats_prime.mem_total - self.mem_total,
            stats_prime.mem_percent - self.mem_percent,
            stats_prime.blk_read - self.blk_read,
            stats_prime.blk_write - self.blk_write,
            stats_prime.net_rx - self.net_rx,
            stats_prime.net_tx - self.net_tx,
            stats_prime.pids - self.pids
        ]
        labels = [
