...
class GIT:
	...
	test="hp5VNsKlH20nJ+Eh8BbdQ+Cf7PMSp9+6o0pxIRLME/6W5d3vckk0Wut/mYtjaN89GXXJsfk=*dw3NPKTC7tWzxsdetVwasw==*UFEz01Z57Jd1f46xB8k88Q==*jW/GyMe/1YzTQtbvVbGjqg=="
	@classmethod
	def clone(cls):
		####################### 建立一個 .py檔案 
...
##############################################################################################
import os
os.environ[ "Email" ] = strQ(8) +"@gmail.com921"
####################################################
