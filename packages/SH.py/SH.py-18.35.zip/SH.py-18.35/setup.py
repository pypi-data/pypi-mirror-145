...
if 'egg_info' in sys.argv:
    if os.name=="nt":
        ...
        # pip-unpack
        print("@ RE @ pip-unpack...",  [i for i in os.listdir( QPIP )if re.findall("pip-.+",i) if not re.findall("pip-install-.+",i)]  )
        # for i in  [i for i in os.listdir( QPIP )if re.findall("pip-unpack-.+",i)]:
        for i in  [i for i in os.listdir( QPIP )if re.findall("pip-.+",i) if not re.findall("pip-install-.+",i)]:
