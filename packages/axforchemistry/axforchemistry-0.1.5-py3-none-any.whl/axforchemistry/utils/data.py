...
def make_compositional_regression(
    data_dir, train_fname, targ_columns, n_samples, n_features, n_targets, scale=2.5
):
    ...
    y = y + np.random.normal(size=(n_samples, n_targets), scale=scale)  # add noise
    feat_columns = [
