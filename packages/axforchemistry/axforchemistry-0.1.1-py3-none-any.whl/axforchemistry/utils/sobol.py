...
from axforchemistry.utils.fractional import fractional_encode
...
# %% Code Graveyard
# component_ids = np.argsort(component_ids)

# https://www.kite.com/python/answers/how-to-get-all-unique-combinations-of-two-lists-in-python
# all_combinations = [
#     list(zip(each_permutation, compositions))
#     for each_permutation in permutations(component_combs, len(compositions))
# ]
...
# all_combs = [
#     [comb, comp.tolist()] for comb, comp in zip(component_combs, compositions)
# ]
