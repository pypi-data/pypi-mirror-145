...
def create_saspyconn(sasobjsp_host, sasobjsp_port, java='/usr/bin/java'):
...
class Abstract_SAS(saspy.SASsession):
    def __init__(self, sasobjsp_user,
                       ...
                       java='/usr/bin/java',
                       **kwargs):
        logging.debug('Initializing Abstrac sas class')
        ...
        super(Abstract_SAS, self).__init__(cfgfile=self.saspy_conn.name,
