...
def start_game():
    ...
    # load skin
    skinfilename = os.path.join(r'.\py_games\games\borgar.png')
    try:
    ...
    pygame.display.set_caption('PushTheBox.py')

    # create PushTheBox object
    skb = PushTheBox()
    ...
    while True:
        ...
        pygame.display.set_caption(skb.solution.__len__().__str__() + '/' + skb.push.__str__() + ' - PushTheBox.py')
