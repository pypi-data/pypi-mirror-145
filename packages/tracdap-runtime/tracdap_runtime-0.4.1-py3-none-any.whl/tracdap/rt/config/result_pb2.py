...
_JOBRESULT_RESULTSENTRY = _JOBRESULT.nested_types_by_name['ResultsEntry']
JobResult = _reflection.GeneratedProtocolMessageType('JobResult', (_message.Message,), {
  ...
  'ResultsEntry' : _reflection.GeneratedProtocolMessageType('ResultsEntry', (_message.Message,), {
    'DESCRIPTOR' : _JOBRESULT_RESULTSENTRY,
    '__module__' : 'tracdap.config.result_pb2'
    # @@protoc_insertion_point(class_scope:tracdap.config.JobResult.ResultsEntry)
    })
  ,
  'DESCRIPTOR' : _JOBRESULT,
  '__module__' : 'tracdap.config.result_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.config.JobResult)
  })
_sym_db.RegisterMessage(JobResult)
_sym_db.RegisterMessage(JobResult.ResultsEntry)
