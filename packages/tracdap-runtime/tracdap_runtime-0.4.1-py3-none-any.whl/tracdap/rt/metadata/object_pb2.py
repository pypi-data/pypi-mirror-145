...
_OBJECTDEFINITION = DESCRIPTOR.message_types_by_name['ObjectDefinition']
ObjectDefinition = _reflection.GeneratedProtocolMessageType('ObjectDefinition', (_message.Message,), {
  'DESCRIPTOR' : _OBJECTDEFINITION,
  '__module__' : 'tracdap.metadata.object_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.ObjectDefinition)
  })
_sym_db.RegisterMessage(ObjectDefinition)
