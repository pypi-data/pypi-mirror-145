...
_SEARCHOPERATOR = DESCRIPTOR.enum_types_by_name['SearchOperator']
SearchOperator = enum_type_wrapper.EnumTypeWrapper(_SEARCHOPERATOR)
...
_SEARCHEXPRESSION = DESCRIPTOR.message_types_by_name['SearchExpression']
...
SearchTerm = _reflection.GeneratedProtocolMessageType('SearchTerm', (_message.Message,), {
  ...
  '__module__' : 'tracdap.metadata.search_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.SearchTerm)
  })
...
LogicalExpression = _reflection.GeneratedProtocolMessageType('LogicalExpression', (_message.Message,), {
  ...
  '__module__' : 'tracdap.metadata.search_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.LogicalExpression)
  })
...
SearchExpression = _reflection.GeneratedProtocolMessageType('SearchExpression', (_message.Message,), {
  ...
  '__module__' : 'tracdap.metadata.search_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.SearchExpression)
  })
...
SearchParameters = _reflection.GeneratedProtocolMessageType('SearchParameters', (_message.Message,), {
  ...
  '__module__' : 'tracdap.metadata.search_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.SearchParameters)
  })
