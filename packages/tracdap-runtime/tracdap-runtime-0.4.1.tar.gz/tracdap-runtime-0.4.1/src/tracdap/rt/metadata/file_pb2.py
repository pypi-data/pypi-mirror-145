...
_FILEDEFINITION = DESCRIPTOR.message_types_by_name['FileDefinition']
FileDefinition = _reflection.GeneratedProtocolMessageType('FileDefinition', (_message.Message,), {
  'DESCRIPTOR' : _FILEDEFINITION,
  '__module__' : 'tracdap.metadata.file_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.FileDefinition)
  })
