...
def single_figure_single_plot(
        ...
        labels_ticks_cbar=None, font_size_labels_ticks_cbar=None,
        ticks_cbar=None, n_ticks_cbar=None,
    ...
    if add_cbar:
        ...
        if labels_ticks_cbar is None:
            ...
            if ticks_cbar is None:
                ...
                cbar = ax.figure.colorbar(im, cax=cax, orientation='vertical', ticks=ticks_cbar)
                cbar.ax.set_yticklabels(labels_ticks_cbar)
            else:
                cbar = ax.figure.colorbar(im, cax=cax, orientation='vertical', ticks=ticks_cbar)
                cbar.ax.set_yticklabels(labels_ticks_cbar)
        ...
        # ax.set_aspect('auto')
        if font_size_labels_ticks_cbar is not None:
            cbar.ax.tick_params(labelsize=font_size_labels_ticks_cbar)
        if label_cbar is not None:
            cbar.ax.set_ylabel(
                label_cbar, rotation=-90, va="bottom", fontsize=font_size_label_cbar)
    # if font_size_cbar_ticklabels != 'auto':
    #     # font_size_cbar_ticklabels = 8
    #     # use matplotlib.colorbar.Colorbar object
    #     cbar = ax.collections[0].colorbar
    #     # here set the labelsize
    #     cbar.ax.tick_params(labelsize=font_size_cbar_ticklabels)
...
def single_figure_multi_plots(
        ...
        labels_ticks_cbars=None, font_sizes_labels_ticks_cbars=None,
        ticks_cbars=None, n_ticks_cbars=None,
        ...
        h_space=None, w_space=None, add_letters_to_titles=True,
    ...
    dict_parameters_rc = dict(
        ...
        labels_ticks_cbars=labels_ticks_cbars, font_sizes_labels_ticks_cbars=font_sizes_labels_ticks_cbars,
        ticks_cbars=ticks_cbars, n_ticks_cbars=n_ticks_cbars,
    ...
    for combination_rc_i in cp_combinations.n_conditions_to_combinations_on_the_fly(shape_rc):
        ...
        if add_letters_to_titles:
            titles[tuple_indexes_rc_i] = (
                    chr(a_num + i) + titles[tuple_indexes_rc_i][slice(1, None, 1)])
        ...
        single_figure_single_plot(
            ...
            title=titles[tuple_indexes_rc_i], font_size_title=font_sizes_titles[tuple_indexes_rc_i],
...
def multi_figures_single_plot(
    ...
    for f in range(n_figures):
        ...
        single_figure_single_plot(
            ...
            labels_ticks_cbar=labels_ticks_cbars[f], font_size_labels_ticks_cbar=font_sizes_labels_ticks_cbars[f],
            ticks_cbar=ticks_cbars[f], n_ticks_cbar=n_ticks_cbars[f],
...
def multi_figures_multi_plots(
        ...
        h_spaces=None, w_spaces=None, add_letters_to_titles=True,
    ...
    for f in range(n_figures):
        ...
        single_figure_multi_plots(
            ...
            h_space=h_spaces[f], w_space=w_spaces[f], add_letters_to_titles=add_letters_to_titles[f],
