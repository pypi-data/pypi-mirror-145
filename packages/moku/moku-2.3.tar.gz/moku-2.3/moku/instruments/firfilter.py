...
class FIRFilterBox(Moku):
    ...
    def set_by_frequency(
        ...
        :type window: `string`, {'None', 'Bartlett', 'Hanning', 'Hamming', 'Blackman', 'Nuttall', 'Tukey', 'Kaiser'} (defaults to None)
    ...
    def set_by_time(
        ...
        :type response: `string`, {'Rectangular', 'Sinc', 'Triangular', 'Gaussian'} (defaults to Sinc)
