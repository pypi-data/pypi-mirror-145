...
def dac_test(chip_reg, pixel_reg, folder_path):
    ...
    for dac_pos_arr in [[0, 2, 4], [1, 3, 5]]:
        for data_ref, data_low, data_max, data_incr in table_test:
            ...
            dac_scan = DacScan(dac_pos_arr, data_ref, data_low, data_max, data_incr)
...
def disc_test(chip_reg, pixel_reg, folder_path):
    global PATH
    ...
    for dac_pos_arr in [[0, 2, 4], [1, 3, 5]]:
        for polarity, disc_value in table_test:
            ...
            disc_scan = DiscScan(dac_pos_arr, data_ref, data_low, data_max, data_incr)
...
def ifeed_test(chip_reg, pixel_reg, folder_path):
    ...
    for iffed_range, ifeed_value in table_test:
        ...
        iffed_scan = IfeedScan(dac_pos, data_ref, data_low, data_max, data_incr)
