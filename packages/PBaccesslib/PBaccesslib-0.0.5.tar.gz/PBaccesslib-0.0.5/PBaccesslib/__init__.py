...
with open(os.path.join(input_data_path, 'input_data', 'init_values.txt')) as f:
    data = f.read()
js = json.loads(data)
IP = js.get("IP")
SYNC = js.get("SYNC")
...
CHIP_REG_PATH = os.path.join(input_data_path, 'input_data', 'chip_reg.npy')
PIXEL_REG_PATH = os.path.join(input_data_path, 'input_data', 'pixel_reg.npy')
