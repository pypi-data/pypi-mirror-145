...
# package_data={'': [f"{os.path.join(here, 'PBaccesslib/data/*.txt')}", f"{os.path.join(here, 'PBaccesslib/data/*.npy')}"]}
setup(name="PBaccesslib",
      ...
      package_data={'': [f"{os.path.join(here, '/PBaccesslib/data/*.txt')}", ]},
      ...
      install_requires=["pandas==1.4.1", "numpy==1.22.3", "python-dateutil==2.8.2", "pytz==2022.1", "six==1.16.0",
                        "typing-extensions==4.1.1", "Excelacceslib==0.0.4", "K2600acceslib==0.0.2",
                        "Commacceslib==0.0.2", "Bconvertacceslib==0.0.1"],
      )
