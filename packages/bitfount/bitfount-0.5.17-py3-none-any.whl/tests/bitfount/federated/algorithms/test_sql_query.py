...
class TestSqlQuery:
    ...
    def test_no_data(self, caplog: LogCaptureFixture, datasource: DataSource) -> None:
        ...
        worker.datasource.data = None  # type: ignore[assignment] # Reason: purpose of test # noqa: B950
        worker.run()
    ...
    def test_sql_output_duplicate_cols_error(
        self, datasource: DataSource, caplog: LogCaptureFixture, mocker: MockerFixture
    ) -> None:
