    ...
    def wrap(
        ...
        Args:
            ...
            missing_columns: What to do with missing columns in the dataframe:
                ...
                - "missing": leave the missing columns missing
            ...
            validate: Whether to run beartype validation on every row
                    (only available if the `beartype <https://github.com/beartype/beartype>`_
                    library is present)
