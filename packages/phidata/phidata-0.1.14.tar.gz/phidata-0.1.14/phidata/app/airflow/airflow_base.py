...
class AirflowBase(PhidataApp):
    ...
    def get_docker_rg(
        ...
        if self.args.open_worker_log_port:
            ...
            container_env["AIRFLOW__LOGGING__WORKER_LOG_SERVER_PORT"] = self.args.worker_log_port
    ...
    def get_k8s_rg(
        ...
        if self.args.open_worker_log_port:
            ...
            if container_env_cm.data is not None:
                container_env_cm.data["AIRFLOW__LOGGING__WORKER_LOG_SERVER_PORT"] = self.args.worker_log_port
