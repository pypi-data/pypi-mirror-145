...
class Api():
    ...
    def __init__(self,
                 ...
                 BASE_ATFBOORU: str = f"https://booru.allthefallen.moe/posts.json",
                 BASE_YANDERE: str = f"https://yande.re/post.json",
                 BASE_KONACHAN: str = f"https://konachan.com/post.json",
                 BASE_KONACHAN_NET: str = f"https://konachan.net/post.json",
                 BASE_LOLIBOORU: str = f"https://lolibooru.moe/post.json",
                 ...
                 BASE_FURBOORU: str = f"https://furbooru.com/api/v1/json/search/images",
                 BASE_BEHOIMI: str = f"http://behoimi.org/post/index.json",
                 BASE_PAHEAL: str = f"https://rule34.paheal.net/api/danbooru/find_posts/index.xml",
