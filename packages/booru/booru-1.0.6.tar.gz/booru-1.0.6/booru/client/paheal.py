...
class Paheal(object):
    ...
    async def search(self, tags: str, limit: int = 100, page: int = 1, random: bool = True, gacha: bool = False):
        ...
        try:
            if gacha:                
                return better_object(self.final['posts']['tag'][randint(0, len(self.final['posts']['tag']))])
    ...
    async def get_image_only(self, tags: str, limit: int = 100, page: int = 1):
