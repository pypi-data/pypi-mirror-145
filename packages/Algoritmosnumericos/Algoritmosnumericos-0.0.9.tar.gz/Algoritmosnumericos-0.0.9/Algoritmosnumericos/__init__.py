...
def dibujo_reg(x,y,grado,tupla,fila,columna,nombre,nombrex,nombrey,label,ax):
    ...
    if columna==0 and fila==0:
        ...
        ax[fila].scatter(x,y,label=label)
        x.sort()
        ax[fila].plot(np.array((np.linspace(x[0],x[-1]),1000))[0],aux_regresion(x,y,grado,tupla))
        ...
        ax[columna].scatter(x,y,label=label)
        x.sort()
        ax[columna].plot(np.array((np.linspace(x[0],x[-1]),1000))[0],aux_regresion(x,y,grado,tupla))
        ...
        ax[fila][columna].scatter(x,y,label=label)
        x.sort()
...
def dibujo_reglineal(x,y,fila,columna,nombre,nombrex,nombrey,ax,label):
    ...
    if columna==0 and fila==0:
        ...
        ax[fila].scatter(x,y,label=label)
        x.sort()
        ax[fila].plot(np.array((np.linspace(x[0],x[-1]),1000))[0],aux_regresionlin(x,y))
        ax[fila].set_xlabel(nombrex)
        ax[fila].set_ylabel(nombrey)
        ax[fila].set_title(nombre)
        ax[fila].legend()
        ...
        ax[columna].scatter(x,y,label=label)
        x.sort()
        ax[columna].plot(np.array((np.linspace(x[0],x[-1]),1000))[0],aux_regresionlin(x,y))
        ax[columna].set_xlabel(nombrex)
        ax[columna].set_ylabel(nombrey)
        ax[columna].set_title(nombre)
        ax[columna].legend()
