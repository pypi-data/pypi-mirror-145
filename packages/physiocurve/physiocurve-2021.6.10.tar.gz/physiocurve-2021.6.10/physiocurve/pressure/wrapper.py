...
class Pressure:
    ...
    @property
    def idxfeet(self):
        return self._index[self.argfeet] if self._index else self.argfeet
    ...
    @property
    def idxdia(self):
        return self._index[self.argdia] if self._index else self.argdia
    ...
    @property
    def idxsys(self):
        return self._index[self.argsys] if self._index else self.argsys
    ...
    @property
    def idxdic(self):
        return self._index[self.argdic] if self._index else self.argdic
