...
class Pipeline(wrapt.ObjectProxy, Generic[AnyStr]):
    ...
    async def xgroup_setid(
        self, key: "KeyT", groupname: "StringT", identifier: "Optional[ValueT]" = None
    ) -> Pipeline: ...
    ...
    async def latency_reset(
        self, events: "Optional[Iterable[StringT]]" = None
    ) -> Pipeline: ...
    ...
    async def cluster_keyslot(self, key: "ValueT") -> Pipeline: ...
    async def cluster_links(self) -> Pipeline: ...
    async def cluster_meet(self, ip: "ValueT", port: "int") -> Pipeline: ...
    ...
    async def cluster_replicate(self, node_id: "ValueT") -> Pipeline: ...
...
class ClusterPipeline(wrapt.ObjectProxy, Generic[AnyStr]):
    ...
    async def cluster_keyslot(self, key: "ValueT") -> ClusterPipeline: ...
    async def cluster_links(self) -> ClusterPipeline: ...
    async def cluster_meet(self, ip: "ValueT", port: "int") -> ClusterPipeline: ...
    ...
    async def cluster_replicate(self, node_id: "ValueT") -> ClusterPipeline: ...
    async def cluster_reset(
        self, hard_soft: "Optional[Literal[PureToken.HARD, PureToken.SOFT]]" = None
    ) -> ClusterPipeline: ...
