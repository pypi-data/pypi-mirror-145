...
from gensyn_client import rest
from gensyn_client.configuration import Configuration
from gensyn_client.exceptions import ApiTypeError, ApiValueError, ApiException
from gensyn_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AugmentationApi()
        api_instance.randomize_smiles  # this is an instance of the class Endpoint
        api_instance.randomize_smiles()  # this invokes api_instance.randomize_smiles.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.randomize_smiles.callable or self.callable in this class
