...
class RandomType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RandomType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.., must be one of ["rotated", "restricted", "unrestricted", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["rotated", "restricted", "unrestricted", ]  # noqa: E501
