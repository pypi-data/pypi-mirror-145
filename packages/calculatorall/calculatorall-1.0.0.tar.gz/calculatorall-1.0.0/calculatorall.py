...
def calculator(write_example_here=""):
    res = str(write_example_here)
    # nums = str(write_example_here)
    def func(nums):
        ii = ""
        nums_list = []
        for i in nums:
    ...
    def calculatorA(nums_list, nums_new):
        try:
            ...
            print("\nResult = ", FloatDelDot.default(res), "\n", sep="")

            return FloatDelDot.default(res)
    ...
    print("\nTo end an iteration, write S and press Enter.\n")
    time.sleep(1)
    ...
    while True:
        try:
            ...
            if nums == "S" or nums == "s" or nums == "S " or nums == "s ":
                False
                print("\nEnd result: ", FloatDelDot.default(res))
                print("PS: 'End Result' - copy in buffer.\n")
                pyperclip3.copy(res)
                return FloatDelDot.default(res)
            ...
            try:
                print("Result: ", FloatDelDot.default(res), '\n')
            except:
                res = 0
                print("Result: ", FloatDelDot.default(res), '\n')
                return FloatDelDot.default(res)