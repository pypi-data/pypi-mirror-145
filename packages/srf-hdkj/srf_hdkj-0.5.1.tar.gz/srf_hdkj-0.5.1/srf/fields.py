...
class Field:
    ...
    def bind(self, field_name, parent):
        ...
        """
        import tortoise
        self.field_name = field_name if not isinstance(parent.instance, tortoise.queryset.QuerySet) else (
            f"{filed_name}_id" if f"{filed_name}_id" in parent.instance.fields else field_name)
        self.parent = parent
