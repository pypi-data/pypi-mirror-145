...
class GraphWidget(DOMWidget):
    ...
    References
    ----------
    `ipywidget docs <https://ipywidgets.readthedocs.io/en/stable/index.html>`_

    `ipywidgets styling docs <https://ipywidgets.readthedocs.io/en/latest/examples/Widget%20Styling.html>`_

    `ipywidgets layout class <https://github.com/jupyter-widgets/ipywidgets/blob/master/python/ipywidgets/
    ipywidgets/widgets/widget_layout.py>`_

    `ipywidgets docs custom serialization <https://ipywidgets.readthedocs.io/en/
    stable/examples/Widget%20Low%20Level.html#Custom-serialization-and-de-serialization-on-the-JavaScript-side>`_
    """
    # TODO add comment about
    #  multiple widgets,
    #  run all behaviour,
    #  mappings in general,
    #  export/update of properties (e.g. comms callbacks)
    # TODO add few more references in comments
    ...
    def __init__(
        ...
        widget_layout: ipywidgets.Layout, optional
            ...
            See references for a link to their documentation and available keywords.
    ...
    def get_nodes(self):
        ...
        This is motivated by the problems of providing docstrings for traitlets.
