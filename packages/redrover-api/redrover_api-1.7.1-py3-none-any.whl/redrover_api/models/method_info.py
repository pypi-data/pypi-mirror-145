...
class MethodInfo(object):
    ...
    def attributes(self, attributes):
        ...
        :type: str
        """
        allowed_values = ["ReuseSlot", "Private", "FamANDAssem", "Assembly", "Family", "FamORAssem", "Public", "MemberAccessMask", "UnmanagedExport", "Static", "Final", "Virtual", "HideBySig", "VtableLayoutMask", "CheckAccessOnOverride", "Abstract", "SpecialName", "RTSpecialName", "PinvokeImpl", "HasSecurity", "RequireSecObject", "ReservedMask"]  # noqa: E501
    ...
    def method_implementation_flags(self, method_implementation_flags):
        ...
        :type: str
        """
        allowed_values = ["Managed", "Native", "OPTIL", "CodeTypeMask", "Unmanaged", "NoInlining", "ForwardRef", "Synchronized", "NoOptimization", "PreserveSig", "AggressiveInlining", "AggressiveOptimization", "InternalCall", "MaxMethodImplVal"]  # noqa: E501
