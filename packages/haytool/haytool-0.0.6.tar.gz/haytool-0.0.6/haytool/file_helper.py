...
def out_filepath(filepath, new_directory='', new_prefix='', new_suffix='', new_filetype=''):
    ...
    if new_filetype:
        new_filename = f'{new_prefix}{head}{new_suffix}.{new_filetype}'
    else:
        new_filename = f'{new_prefix}{head}{new_suffix}{ext}'
    if new_directory:
        new_outfilepath = os.path.join(new_directory, new_filename)
    else:
        new_outfilepath = os.path.join(directory, new_filename)
