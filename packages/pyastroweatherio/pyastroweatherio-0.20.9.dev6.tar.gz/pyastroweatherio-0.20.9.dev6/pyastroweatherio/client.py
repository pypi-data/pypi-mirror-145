...
class AstroWeather:
    ...
    def __init__(
        ...
        cloudcover_weight=CONDITION_CLOUDCOVER_WEIGHT,
        seeing_weight=CONDITION_SEEING_WEIGHT,
        transparency_weight=CONDITION_TRANSPARENCY_WEIGHT,
    ):
    ...
    async def _get_location_data(self) -> None:
        ...
        for row in self._weather_data:
            ...
            item = {
                ...
                # "cloudcover_weight": self._cloudcover_weight,
                # "seeing_weight": self._seeing_weight,
                # "transparency_weight": self._transparency_weight,
    ...
    async def calc_condition_percentage(self, cloudcover, seeing, transparency):
        ...
        #   Transparency: 1-8
        _LOGGER.debug(
            "Calc condition cloudcover: %d(%d), seeing %d(%d), transparency: %d(%d)",
            cloudcover,
