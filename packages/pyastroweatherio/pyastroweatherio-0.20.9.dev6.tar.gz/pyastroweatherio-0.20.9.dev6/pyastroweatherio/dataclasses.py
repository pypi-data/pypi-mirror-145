...
class LocationData(BaseData):
    ...
    def __init__(self, data):
        ...
        # self._cloudcover_weight = data["cloudcover_weight"]
        # self._seeing_weight = data["seeing_weight"]
        # self._transparency_weight = data["transparency_weight"]
    ...
    # @property
    # def cloudcover_weight(self) -> int:
    #     """Return cloud cover weight for condition calculation"""
    #     return self._cloudcover_weight

    # def set_cloudcover_weight(self, weight) -> None:
    #     """Set cloud cover weight for condition calculation"""
    #     self._cloudcover_weight = weight

    # @property
    # def seeing_weight(self) -> int:
    #     """Return seeing weight for condition calculation"""
    #     return self._seeing_weight

    # def set_seeing_weight(self, weight) -> None:
    #     """Set seeing weight for condition calculation"""
    #     self._seeing_weight = weight

    # @property
    # def transparency_weight(self) -> int:
    #     """Return transparency weight for condition calculation"""
    #     return self._transparency_weight

    # def set_transparency_weight(self, weight) -> None:
    #     """Return transparency weight for condition calculation"""
    #     self._transparency_weight = weight
