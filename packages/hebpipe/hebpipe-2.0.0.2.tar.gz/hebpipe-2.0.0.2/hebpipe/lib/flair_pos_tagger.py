...
IAHLT_ROOT = "C:\\Uni\\Corpora\\Hebrew\\IAHLT_ALL\\for_tagger" + os.sep  # Path to IAHLT HTB repo
...
if __name__ == "__main__":
    ...
    p.add_argument("-s","--seg",action="store_true",help="Whether to train segmentation instead of tagging")  # args: -m train -s
