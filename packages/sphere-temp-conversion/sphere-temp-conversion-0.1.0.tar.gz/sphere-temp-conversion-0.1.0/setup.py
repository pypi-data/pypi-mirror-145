...
about = {}
with open(os.path.join(here, 'sphere_temp_conversion', '__version__.py')) as f:
    exec(f.read(), about)
...
setup_args = dict(
    ...
    url='https://github.com/thvranken/sphere-temp-conversion',
