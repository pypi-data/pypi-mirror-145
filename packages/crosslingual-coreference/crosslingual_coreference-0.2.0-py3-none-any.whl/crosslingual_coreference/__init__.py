...
from .CrossLingualPredictorSpacy import CrossLingualPredictorSpacy as SpacyPredictor
...
@Language.factory(
    "xx_coref",
    default_config={"device": -1, "model_name": "info_xlm", "chunk_size": None, "chunk_overlap": 2},
)
