...
class AzureSSOConfig(BaseModel):
    ...
    secretKey: str = Field(..., description='Azure SSO client secret key')
    authority: Optional[str] = Field(None, description='Azure SSO Authority')
    clientId: Optional[str] = Field(None, description='Azure Client ID.')
    scopes: Optional[List[str]] = Field(None, description='Azure Client ID.')
